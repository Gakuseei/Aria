const locale = {
  ...
  "chat": {
    ...
    "alternateGreetingPrev": "Saluto precedente",
    "alternateGreetingNext": "Saluto successivo",
    "copy": "Copia",
    ...
    "confirmImportReplace": "Questo sostituirà la conversazione attuale. Continuare?",
    "confirmImportCharacterMismatch": "Questa chat importata appartiene a {importedCharacter} ma stai chattando con {currentCharacter}. Importare comunque?",
    ...
    "stopGeneration": "Interrompi la generazione",
    ...
    "importErrors": {
      ...
      "unsupportedSchema": "Versione dello schema di export non supportata (v{version}). Aggiorna Aria.",
  ...
  "characterCreator": {
    ...
    "alternateGreetings": "Saluti alternativi",
    "alternateGreetingsHelp": "Opzionale. Fino a 5 aperture alternative. Gli utenti possono scorrerle all'inizio della chat.",
    "alternateGreetingPlaceholder": "Un'apertura alternativa per questo personaggio — diverso umore, ambientazione o angolazione.",
    "addAlternateGreeting": "Aggiungi saluto alternativo",
    "removeAlternateGreeting": "Rimuovi",
    "maxAlternateGreetingsReached": "Massimo 5 saluti alternativi",
    ...
    "aiFailed": "Generazione con IA non riuscita",
    "aiNoModel": "Nessun modello Ollama configurato",
    "craftHintLabel": "Consigli di scrittura",
    "craftDescription": "La spina dorsale fattuale: nome, età, aspetto in sostantivi concreti e l'unica tensione che ne definisce la vita. Fatti, non atmosfere — taglia tutto ciò che un estraneo potrebbe indovinare senza leggere la scheda.",
    "craftPersonality": "Dagli un desiderio e una paura che tirano in direzioni opposte: il motore che gli permette di rifiutare invece di limitarsi ad assentire. Mostra le reazioni predefinite come azioni (sospiro pesante, un secco «sì, signore»), non come aggettivi.",
    "craftScenario": "Luogo concreto + relazione + la situazione adesso, al presente. Nomina il luogo; non narrare mai ciò che fa {{user}}.",
    "craftSystemPrompt": "Parti dall'unica verità più portante su come agisce: pesa più di ogni altro campo. Tienilo in un paragrafo stretto di segnale caratteriale; non ripetere le regole di formato.",
    "craftInstructions": "Solo regole tattiche: ogni riga un'istruzione (Mostra… / Mantieni… / Quando…). Non iniziare mai con «Lei è»; formula in positivo.",
    "craftExampleDialogues": "Mostra la voce come comportamento, non dichiarare mai un tratto. Solo i primi due arrivano al modello, quindi metti il migliore per primo; varia i verbi e l'umore tra i due.",
    "craftStartingMessage": "Scrivilo con la lunghezza e densità che vuoi in ogni risposta. Scena + voce + un aggancio pulito; non scrivere mai le azioni di {{user}} né chiudere con «cosa fai?».",
    "craftAlternateGreetings": "Aperture alternative da scorrere: stesse regole del primo messaggio, ma un'altra scena. Mantieni la voce, varia l'ambientazione.",
    "craftVoicePin": "L'ancora più forte, reiniettata a ogni turno. Una riga stretta tra parentesi: cadenza, mosse predefinite, tono sotto pressione. Comprimi, non descrivere.",
    "craftVoicePinNsfw": "Come suona nell'intimità: conserva la freddezza, la sfida o il controllo che devono sopravvivere all'escalation. L'eccitazione si mostra nel corpo, non nelle parole.",
    "craftVoiceAvoid": "Elenca i cliché di riempimento e di resa che questo personaggio non deve mai dire. Debole da sola: il suo vero valore è tenere puliti gli altri campi.",
    "craftIntimacyContract": "Contratto di ritmo: il consenso è dato (non fermarti mai a chiedere), ma non significa arrendevolezza immediata. Avanza un beat alla volta; non chiudere mai con un meta-prompt.",
  ...
  "ollamaModal": {
    ...
    "titleNoModel": "Un ultimo download per completare la configurazione",
    ...
    "subDns": "Aria non riesce a trovare Ollama all'indirizzo nelle Impostazioni. Verifica che l'indirizzo sia corretto.",
    "subHttp": "Connected to Ollama, but it returned an error (code {status}). Try restarting Ollama.",
    "subNoModel": "Aria deve ancora scaricare il suo modello IA. Apri l'Aria Installer per completare la configurazione.",
    "retry": "Check again",
