const locale = {
  ...
  "settings": {
    ...
    "userPronouns": "Pronoms",
    "pronounsHelper": "Définis automatiquement selon le genre. Modifiable.",
    "pronounsCustom": "Personnalisé...",
    "pronounsCustomPlaceholder": "ex. ze/zir, fae/faer, tout pronom",
    "oledMode": "Mode OLED",
    "themeMode": "Thème",
    "darkMode": "Sombre",
    "lightMode": "Clair",
    ...
    "samplingModalEyebrow": "Par modèle",
    "samplingModalTitle": "Paramètres de Sampling",
    "samplingModalOverridesActive": "{count} surcharge active",
    "samplingModalOverridesActivePlural": "{count} surcharges actives",
    "samplingModalNoOverrides": "Aucune surcharge",
    "samplingPanelEdit": "Modifier",
    "samplingPanelSummary": "{summary}",
    "samplingTabSampling": "Sampling",
    "samplingTabDry": "DRY",
    "samplingDrySectionCap": "Paramètres",
    "samplingFooterControls": "{count} contrôles — {tab}",
    "samplingFooterControlsOne": "{count} contrôle — {tab}",
    "samplingFooterReset": "Tout réinitialiser",
    "samplingFooterDone": "Terminé",
    "samplingHelperTemperature": "Bas = ciblé et prévisible. Haut = créatif et surprenant.",
    "samplingHelperTopP": "Nucleus sampling — meilleurs tokens par probabilité cumulée.",
    "samplingHelperMinP": "Élimine les tokens peu probables pour plus de cohérence.",
    "samplingHelperRepeatPenalty": "Décourage la répétition des tokens récents. 1.0 = désactivé.",
    "samplingHelperTopK": "Limite stricte de candidats par token. 0 = désactivé.",
    "samplingHelperRepeatLastN": "Distance sur laquelle s'applique la Repeat Penalty.",
    "samplingHelperPenalizeNewline": "Considère les sauts de ligne comme une répétition.",
    "samplingHelperDry": "Pénalise les répétitions littérales plus fortement que Repeat Penalty.",
    ...
    "suggestionModelTitle": "Modèle de Suggestions Intelligentes",
    "suggestionModelDesc": "Un petit modèle séparé, non censuré et non-thinking. Génère les trois pastilles de réponse en parallèle de votre modèle de chat.",
    "suggestionModelInstalled": "INSTALLÉ",
    "suggestionModelNotInstalled": "NON INSTALLÉ",
    "suggestionModelPull": "Télécharger",
    "suggestionModelCheck": "Vérifier",
    "suggestionModelCustom": "Personnalisé (avancé)",
    "suggestionModelCustomHint": "Saisissez n'importe quel tag Ollama. Doit être non censuré, sans raisonnement et compatible JSON.",
    "suggestionModelFallbackTitle": "Repli sur le modèle de chat",
    "suggestionModelFallbackDesc": "Si le modèle de suggestions échoue ou est indisponible, le modèle de chat est utilisé à la place.",
    "suggestionModelEditProfile": "Modifier le profil d'échantillonnage",
    ...
    "suggestionModelPullStarting": "démarrage",
    "suggestionModelPullManifest": "récupération du manifeste",
    "suggestionModelPullDownloading": "téléchargement",
    "suggestionModelPullVerifying": "vérification",
    "suggestionModelPullWriting": "écriture",
    "suggestionModelPullCleanup": "nettoyage",
  ...
  "chat": {
    ...
    "send": "Envoyer",
    "suggestButton": "Suggérer des réponses",
    "suggestLoading": "Génération…",
    "suggestError": "Suggestions indisponibles.",
    "impersonate": "Écrire pour moi",
    "editMessage": "Modifier le message",
    "editSave": "Enregistrer",
    "editCancel": "Annuler",
    "revertTurn": "Annuler le dernier tour",
    "isTyping": "{name} écrit...",
  ...
  "aiCharacterBuilder": {
    ...
    "voicePinLabel": "Ancre vocale",
    "voicePinHelp": "Optionnel. 1-3 phrases décrivant comment ce personnage parle et reste dans son rôle. Le signal unique le plus fort de cohérence de persona.",
    "voicePinNsfwLabel": "Ancre vocale (override NSFW)",
    "voicePinNsfwHelp": "Optionnel. À utiliser uniquement si la voix du personnage en scène intime diffère sensiblement de sa voix par défaut.",
    "intimacyContractLabel": "Contrat d'intimité",
    "intimacyContractHelp": "Optionnel. 2-4 phrases courtes nommant le comportement structurel que le personnage doit conserver pendant les scènes intimes (cadence, phrases signature, ce qu'il ne devient jamais). Toujours inclus en entier en profondeur NSFW — jamais tronqué.",
    "voiceAvoidLabel": "Phrases à éviter",
