const locale = {
  ...
  "chat": {
    ...
    "gatekeeper": "制御中",
    "unchained": "解放モード",
    "modeNarratorIndicator": "ストーリーモード",
    ...
    "isTyping": "{name} 入力中...",
    "alternateGreetingPrev": "前の挨拶",
    "alternateGreetingNext": "次の挨拶",
    "copy": "コピー",
    "testError": "接続テストエラー",
    "about": "概要",
  ...
  "characterCreator": {
    ...
    "alternateGreetings": "代替挨拶",
    "alternateGreetingsHelp": "任意。最大5つの代替オープニング。ユーザーはチャット開始時に切り替えられます。",
    "alternateGreetingPlaceholder": "このキャラクターの代替的なオープニング — 異なる雰囲気、舞台、視点。",
    "addAlternateGreeting": "代替挨拶を追加",
    "removeAlternateGreeting": "削除",
    "maxAlternateGreetingsReached": "代替挨拶は最大5つです",
    ...
    "aiNoModel": "Ollamaモデルが設定されていません",
    "craftHintLabel": "執筆のヒント",
    "craftDescription": "事実の背骨:名前、年齢、具体的な名詞での外見、そしてその人生を定義する唯一の緊張。雰囲気ではなく事実を書く——カードを読まずとも他人が言い当てられるものは削る。",
    "craftPersonality": "互いに引き合う「欲」と「恐れ」を与える——ただ同意するのではなく拒める原動力になる。既定の反応は形容詞ではなく行動で示す(深いため息、そっけない「はい、旦那様」)。",
    "craftScenario": "具体的な場所＋関係＋今この瞬間の状況を現在形で。場所を名指しし、{{user}}の行動は決して描写しない。",
    "craftSystemPrompt": "彼らの振る舞い方について最も肝心な一つの真実から始める——他のどの欄より重い。特徴の信号を凝縮した一段落に留め、書式ルールは繰り返さない。",
    "craftInstructions": "戦術的な規則のみ——各行を指示にする(示せ… / 保て… / ～のとき…)。「彼女は～」で始めない。肯定形で書く。",
    "craftExampleDialogues": "特徴は宣言せず、声を振る舞いで示す。モデルに届くのは最初の2つだけなので、最も強いものを先に。両者で動詞と気分を変える。",
    "craftStartingMessage": "毎回の返信に望む長さと密度で書く。情景＋声＋一つの明快なフック。{{user}}の行動は書かず、「どうする?」で終えない。",
    "craftAlternateGreetings": "スワイプ用の代替オープニング:最初のメッセージと同じ規則で、場面だけ変える。声は保ち、舞台を変える。",
    "craftVoicePin": "最強のアンカー——毎ターン再注入される。角括弧の凝縮した一行:調子、既定の所作、圧力下のトーン。描写ではなく圧縮を。",
    "craftVoicePinNsfw": "親密な場面での響き——エスカレートしても残すべき冷たさ、反抗、支配を保つ。興奮は言葉ではなく身体で示す。",
    "craftVoiceAvoid": "このキャラが決して言ってはならない具体的な陳腐句・服従の常套句を挙げる。単体では弱い——真の価値は他の欄を清潔に保つこと。",
    "craftIntimacyContract": "ペース契約:同意は既にある(尋ねるために止まらない)が、即座の従順ではない。一拍ずつ進め、メタな問いかけで終えない。",
  ...
  "characters": {
    ...
    "narrator-chronicler": {
      ...
      "subtitle": "文学的ナレーター",
      "tagline": "文学的、全知。",
      "description": "中立的で文学的な、三人称全知のナレーター。あなたの入力を会話ではなくシーンに変える、抑制された観察的な散文。"
    },
    "narrator-noir": {
      "name": "Noir Narrator",
      "subtitle": "ハードボイルド・ナレーター",
      "tagline": "ハードボイルド、現在形。",
      "description": "ハードボイルドなノワール・ナレーター。現在形。パンチのように決まる短い文。煙、雨、安いウイスキー、そして結末。"
    }
  },
  "ollamaModal": {
    "titleUnreachable": "Open Ollama",
    "titleNoModel": "セットアップ完了まであと一つのダウンロードです",
    ...
    "subDns": "設定のアドレスでは Aria が Ollama を見つけられません。アドレスが正しいかご確認ください。",
    "subHttp": "Connected to Ollama, but it returned an error (code {status}). Try restarting Ollama.",
    "subNoModel": "Aria はまだ AI モデルをダウンロードする必要があります。Aria Installer を開いてセットアップを完了してください。",
    "retry": "Check again",
    "settings": "詳細設定"
  }
};
