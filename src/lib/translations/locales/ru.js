const locale = {
  ...
  "settings": {
    ...
    "suggestionModelCheck": "Проверить",
    "suggestionModelCustom": "Своя (расширенно)",
    "suggestionModelCustomHint": "Введите любой тег Ollama. Должна быть без цензуры, без рассуждений и поддерживать формат JSON.",
    "suggestionModelFallbackTitle": "Откат на модель чата",
    "suggestionModelFallbackDesc": "Если модель подсказок недоступна или сбоит, вместо неё используется модель чата.",
    "suggestionModelEditProfile": "Редактировать профиль семплинга",
