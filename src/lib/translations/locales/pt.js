const locale = {
  ...
  "settings": {
    ...
    "userPronouns": "Pronomes",
    "pronounsHelper": "Definidos automaticamente pelo gênero. Edite para sobrescrever.",
    "pronounsCustom": "Personalizado...",
    "pronounsCustomPlaceholder": "ex. ze/zir, fae/faer, qualquer pronome",
    "oledMode": "Modo OLED",
    ...
    "samplingModalTitle": "Configurações de Sampling",
    "samplingModalOverridesActive": "{count} substituição ativa",
    "samplingModalOverridesActivePlural": "{count} substituições ativas",
    "samplingModalNoOverrides": "Sem substituições",
    "samplingPanelEdit": "Editar",
    "samplingPanelSummary": "{summary}",
    "samplingTabSampling": "Sampling",
    "samplingTabDry": "DRY",
    "samplingDrySectionCap": "Parâmetros",
    "samplingFooterControls": "{count} controles — {tab}",
    "samplingFooterControlsOne": "{count} controle — {tab}",
    "samplingFooterReset": "Redefinir tudo",
    "samplingFooterDone": "Pronto",
    "samplingHelperTemperature": "Baixo = focado e previsível. Alto = criativo e surpreendente.",
    "samplingHelperTopP": "Nucleus sampling — tokens principais por probabilidade cumulativa.",
    "samplingHelperMinP": "Descarta tokens de baixa probabilidade para mais coerência.",
    "samplingHelperRepeatPenalty": "Desencoraja repetir tokens recentes. 1.0 = desativado.",
    "samplingHelperTopK": "Limite rígido de candidatos por token. 0 = desativado.",
    "samplingHelperRepeatLastN": "Quão para trás a Repeat Penalty se aplica.",
    "samplingHelperPenalizeNewline": "Trata quebras de linha como repetição.",
    "samplingHelperDry": "Penaliza repetições literais mais que Repeat Penalty.",
    "samplingHelperDryMultiplier": "Intensidade da penalidade de repetição.",
    "samplingHelperDryBase": "Maior = penalidade mais forte para repetições longas.",
    "samplingHelperDryAllowedLength": "Repetições até este comprimento passam sem penalidade.",
    "samplingHelperDryPenaltyLastN": "Janela de tokens examinada pela penalidade.",
    "samplingResetField": "Reverter ao padrão",
    "suggestionModelTitle": "Modelo de Sugestões Inteligentes",
    "suggestionModelDesc": "Um modelo pequeno separado, sem censura e sem pensamento. Gera as três pílulas de resposta em paralelo ao seu modelo de chat.",
    "suggestionModelInstalled": "INSTALADO",
    "suggestionModelNotInstalled": "NÃO INSTALADO",
    "suggestionModelPull": "Baixar",
    "suggestionModelCheck": "Verificar",
    "suggestionModelCustom": "Personalizado (avançado)",
    "suggestionModelCustomHint": "Digite qualquer tag do Ollama. Deve ser sem censura, sem raciocínio e compatível com formato JSON.",
    "suggestionModelFallbackTitle": "Recorrer ao modelo de chat",
    "suggestionModelFallbackDesc": "Se o modelo de sugestões falhar ou estiver indisponível, o modelo de chat é usado em seu lugar.",
    "suggestionModelEditProfile": "Editar perfil de amostragem",
    ...
    "suggestionModelPullManifest": "obtendo manifesto",
    "suggestionModelPullDownloading": "baixando",
    "suggestionModelPullVerifying": "verificando",
    "suggestionModelPullWriting": "gravando",
  ...
  "chat": {
    ...
    "send": "Enviar",
    "suggestButton": "Sugerir respostas",
    "suggestLoading": "Gerando…",
    "suggestError": "Sugestões indisponíveis.",
    "impersonate": "Escrever por mim",
    "editMessage": "Editar mensagem",
    "editSave": "Salvar",
    "editCancel": "Cancelar",
    "revertTurn": "Desfazer último turno",
