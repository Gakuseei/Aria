const locale = {
  ...
  "settings": {
    ...
    "pronounsHelper": "Auto-set from gender. Edit to override.",
    "pronounsCustom": "Custom...",
    "pronounsCustomPlaceholder": "e.g. ze/zir, fae/faer, any pronouns",
    "oledMode": "OLED Mode",
    "themeMode": "Theme",
    "darkMode": "Dark",
    "lightMode": "Light",
    ...
    "samplingResetField": "Revert to default",
    ...
    "samplingModalEyebrow": "Per-model",
    "samplingModalTitle": "Sampling Settings",
    "samplingModalOverridesActive": "{count} override active",
    "samplingModalOverridesActivePlural": "{count} overrides active",
    "samplingModalNoOverrides": "No overrides",
    "samplingPanelEdit": "Edit",
    "samplingPanelSummary": "{summary}",
    "samplingTabSampling": "Sampling",
    "samplingTabDry": "DRY",
    "samplingDrySectionCap": "Parameters",
    "samplingFooterControls": "{count} controls — {tab}",
    "samplingFooterControlsOne": "{count} control — {tab}",
    "samplingFooterReset": "Reset all",
    "samplingFooterDone": "Done",
    "samplingHelperTemperature": "Lower = focused & predictable. Higher = creative & surprising.",
    "samplingHelperTopP": "Nucleus sampling — top tokens by cumulative probability.",
    "samplingHelperMinP": "Drops low-probability tokens for tighter coherence.",
    "samplingHelperRepeatPenalty": "Discourages repeating recent tokens. 1.0 = off.",
    "samplingHelperTopK": "Hard cap on candidates per token. 0 = disabled.",
    "samplingHelperRepeatLastN": "How far back to apply the repeat penalty.",
    "samplingHelperPenalizeNewline": "Treats line breaks as repetition.",
    "samplingHelperDry": "Penalizes verbatim repeats more aggressively than Repeat Penalty.",
    "samplingHelperDryMultiplier": "Strength of the repeat penalty.",
    "samplingHelperDryBase": "Higher = stronger penalty for longer repeats.",
    "samplingHelperDryAllowedLength": "Repeats up to this length pass without penalty.",
    "samplingHelperDryPenaltyLastN": "Token window the penalty looks back over.",
  },
  "chat": {
    "passion": "Passion",
    ...
    "send": "Send",
    "suggestButton": "Suggest replies",
    "suggestLoading": "Generating…",
    "suggestError": "Suggestions unavailable.",
    "impersonate": "Write for me",
    "editMessage": "Edit message",
    "editSave": "Save",
    "editCancel": "Cancel",
    "revertTurn": "Revert last turn",
    "isTyping": "{name} is typing...",
    "alternateGreetingPrev": "Previous greeting",
    "alternateGreetingNext": "Next greeting",
    "copy": "Copy",
    ...
    "importChatFileAria": "Import chat file",
    "confirmImportReplace": "This will replace your current conversation. Continue?",
    "confirmImportCharacterMismatch": "This imported chat belongs to {importedCharacter} but you are currently chatting with {currentCharacter}. Import anyway?",
    "importErrors": {
      "invalidJson": "This file is not valid JSON.",
      "notAriaExport": "This file is not an Aria export.",
      "wrongKind": "This file is not a chat export. (Found: {kind})",
      "unsupportedSchema": "Unsupported export schema version (v{version}). Please update Aria.",
      "missingPayload": "Export file is missing data."
    },
  ...
  "characterSelect": {
    ...
    "importCharacterFileAria": "Import character file",
    "storageFull": "Storage full — remove some character avatars to free space",
    "importErrors": {
      "invalidJson": "This file is not valid JSON.",
      "notAriaExport": "This file is not an Aria export.",
      "wrongKind": "This file is not a character export. (Found: {kind})",
      "unsupportedSchema": "Unsupported export schema version (v{version}). Please update Aria.",
      "missingPayload": "Export file is missing data.",
      "missingRequiredFields": "Character file is missing required fields (name, system prompt, starting message)."
    },
    "custom": "Custom",
  ...
  "aiCharacterBuilder": {
    ...
    "fieldExampleDialogue": "Example Dialogues",
    ...
    "intimacyContractLabel": "Intimacy Contract",
    "intimacyContractHelp": "Optional. 2-4 short sentences naming the structural behavior the character must keep during intimate scenes (cadence, signature phrases, what they never become). Always included whole at NSFW depth — never clipped.",
  ...
  "characterCreator": {
    ...
    "designCustom": "Design your own custom AI character",
    ...
    "tip6": "Duplicates are prevented automatically.",
    "preview": "Preview",
    ...
    "scenario": "Scenario",
    "scenarioPlaceholder": "A quiet bar on the edge of town, late evening. {{user}} is a regular; {{char}} just walked in for the first time.",
    "recommended": "recommended",
    "scenarioTip": "Where + when + relationship to user. Short paragraph.",
    ...
    "alternateGreetingsHelp": "Optional. Up to 5 alternative openings. Users can swipe through them at chat start.",
    "alternateGreetingPlaceholder": "An alternative opening for this character — different mood, setting, or angle.",
    "addAlternateGreeting": "Add Alternate Greeting",
    "removeAlternateGreeting": "Remove",
    "maxAlternateGreetingsReached": "Maximum 5 alternate greetings",
    "namePlaceholderV2": "e.g., Luna, Commander Rex, Dr. Noir",
    "subtitlePlaceholderV2": "e.g., Mysterious Witch, Shy Librarian, Loyal Servant",
    "descriptionPlaceholderV2": "Tall and lean, mid-thirties, dresses in worn leather jacket. Quick gestures, sharper eyes. Has a habit of tapping her ring against glass when thinking.",
    "descriptionHint": "Appearance + demeanor + key quirk. Third-person present tense. Avoid wall-of-text.",
    "systemPromptPlaceholderV2": "You are {{char}}, in a fictional uncensored roleplay with {{user}}. Stay in character; describe actions in vivid detail.",
    ...
    "startingMessagePlaceholderV2": "*She slides onto the stool next to {{user}}, ordering with two fingers raised.* \"Whatever they're drinking.\" *A half-smile.* \"You look like you've had a day.\"",
    "systemPromptTipV2": "Per-card voice override. Activation slot for NSFW-tone.",
    "startingMessageTipV2": "Action → Dialogue → Hook. Don't lock {{user}}'s POV.",
    ...
    "voicePinLabel": "Voice Anchor",
    "voicePinHelp": "Stage direction injected every turn. 1-2 sentences, present-tense, bracketed.",
    "voicePinNsfwLabel": "Voice Anchor (NSFW Override)",
    "voicePinNsfwHelp": "NSFW voice-override. Applied when assistMode = nsfw_only.",
    "intimacyContractLabel": "Intimacy Contract",
    "intimacyContractHelp": "NSFW reinforcement. Applied at history tail. 1-2 sentences imperative.",
    "voiceAvoidLabel": "Avoid Phrases",
    "voiceAvoidHelp": "Phrases to avoid. Comma-separated. Wired to prompt as 'Avoid these phrases: …'.",
    "voicePinGenerate": "Suggest with AI",
    "voicePinGenerating": "Generating...",
    "aiGenerate": "Generate",
    "aiImprove": "Improve",
    ...
    "aiNoModel": "No Ollama model configured",
    "craftHintLabel": "Writing tips",
    "craftDescription": "The factual spine: name, age, appearance in concrete nouns, and the one tension that defines their life. State facts, not vibes — cut anything a stranger could guess without reading the card.",
    "craftPersonality": "Give them a want and a fear that pull against each other — the engine that lets them refuse instead of just agreeing. Show defaults as actions (heavy sigh, flat \"yes sir\"), not adjectives.",
    "craftScenario": "Concrete place + relationship + the situation right now, present tense. Name the location; never narrate what {{user}} does.",
    "craftSystemPrompt": "Lead with the single most load-bearing truth about how they act — it outweighs every other field. Keep it one tight paragraph of trait signal; don't restate format rules.",
    "craftInstructions": "Tactical rules only — every line an instruction (Show… / Keep… / When…). Never start a line with \"She is\"; frame it positively.",
    "craftExampleDialogues": "Show voice as behavior, never announce a trait. Only the first two reach the model, so put the strongest first; vary the verbs and the mood between them.",
    "craftStartingMessage": "Write it at the length and density you want every reply to be. Scene + voice + one clean hook; never write {{user}}'s actions or end on \"what do you do?\".",
    "craftAlternateGreetings": "Swipe-alternative openers: same rules as the first message, but a different scene. Hold the voice, vary the setting.",
    "craftVoicePin": "The strongest anchor — re-injected every turn. One tight bracketed line: cadence, default moves, tone under pressure. Compress, don't describe.",
    "craftVoicePinNsfw": "How they sound under intimacy — keep the coldness, defiance, or control that must survive escalation. Arousal shows in the body, not in the words.",
    "craftVoiceAvoid": "List the specific slop and surrender-clichés this character must never say. Weak on its own — its real value is keeping your other fields clean.",
    "craftIntimacyContract": "Pacing contract: consent is standing (never pause to ask), but not instant compliance. Advance one beat at a time; never end on a meta prompt."
  },
  "creative": {
    ...
    "importStoryFileAria": "Import story file",
    "importErrors": {
      "invalidJson": "This file is not valid JSON.",
      "notAriaExport": "This file is not an Aria export.",
      "wrongKind": "This file is not a story export. (Found: {kind})",
      "unsupportedSchema": "Unsupported export schema version (v{version}). Please update Aria.",
      "missingPayload": "Export file is missing data.",
      "missingRequiredFields": "Story file is missing required content."
    },
    "genre": "Genre",
