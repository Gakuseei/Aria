const locale = {
  ...
  "settings": {
    ...
    "userGender": "你的性别",
    "userPronouns": "代词",
    "pronounsHelper": "根据性别自动设置。可编辑覆盖。",
    "pronounsCustom": "自定义...",
    "pronounsCustomPlaceholder": "例如 ze/zir、fae/faer 或任意代词",
    "oledMode": "OLED模式",
    "themeMode": "主题",
    "darkMode": "深色",
    "lightMode": "浅色",
    ...
    "voiceStandard": "标准",
    "voicePremium": "高级",
    "samplingModalEyebrow": "按模型",
    "samplingModalTitle": "Sampling 设置",
    "samplingModalOverridesActive": "已启用 {count} 项覆盖",
    "samplingModalOverridesActivePlural": "已启用 {count} 项覆盖",
    "samplingModalNoOverrides": "无覆盖",
    "samplingPanelEdit": "编辑",
    "samplingPanelSummary": "{summary}",
    "samplingTabSampling": "Sampling",
    "samplingTabDry": "DRY",
    "samplingDrySectionCap": "参数",
    "samplingFooterControls": "{count} 个控件 — {tab}",
    "samplingFooterControlsOne": "{count} 个控件 — {tab}",
    "samplingFooterReset": "全部重置",
    "samplingFooterDone": "完成",
    "samplingHelperTemperature": "低 = 专注且可预测。高 = 富有创意且出人意料。",
    "samplingHelperTopP": "Nucleus sampling — 按累积概率取顶部 token。",
    "samplingHelperMinP": "丢弃低概率 token,使输出更连贯。",
    "samplingHelperRepeatPenalty": "抑制最近 token 的重复。1.0 = 关闭。",
    "samplingHelperTopK": "每个 token 的候选数硬上限。0 = 关闭。",
    "samplingHelperRepeatLastN": "Repeat Penalty 回溯应用的范围。",
    "samplingHelperPenalizeNewline": "将换行视为重复。",
    "samplingHelperDry": "比 Repeat Penalty 更强地惩罚逐字重复。",
    ...
    "suggestionModelCheck": "检测",
    "suggestionModelCustom": "自定义（高级）",
    "suggestionModelCustomHint": "输入任意 Ollama 标签。需为无审查、非思考型且支持 JSON 格式。",
    "suggestionModelFallbackTitle": "回退到聊天模型",
    "suggestionModelFallbackDesc": "当建议模型失败或不可用时，改用你的聊天模型。",
    "suggestionModelEditProfile": "编辑采样配置",
