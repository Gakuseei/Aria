...
export const translations = {
  en: {
    ...
    chat: {
      ...
      passionShy: "Shy",
      passionCurious: "Curious",
      passionFlirty: "Flirty",
      passionHeated: "Heated",
      passionPassionate: "Passionate",
      passionPrimal: "Primal",
      passionTooltip: "Passion determines character willingness. Shy (0-15) → Curious (16-30) → Flirty (31-50) → Heated (51-70) → Passionate (71-85) → Primal (86+)",
      presetFresh: "Start Fresh",
      presetCurious: "Skip to Curious",
      presetFlirty: "Skip to Flirty",
      presetHeated: "Skip to Heated",
      ...
      passionRising: "Passion rising",
      passionFalling: "Passion falling",
      passionStable: "Passion stable",
      passionStagnant: "Passion stagnant — try escalating",
      passionStreak: "Romantic streak: {count} messages",
      tierUp: "Passion: {from} → {to}",
      tierDown: "Cooled: {from} → {to}",
      enableUnchainedConfirm: "Enable Unchained Mode? This disables passion gatekeeping — the character will respond to intimate content at any passion level.",
      disableUnchainedConfirm: "Disable Unchained Mode? Passion gatekeeping will resume at the current level ({level}%).",
  ...
  de: {
    ...
    chat: {
      ...
      passionShy: "Schüchtern",
      passionCurious: "Neugierig",
      passionFlirty: "Flirtend",
      passionHeated: "Erhitzt",
      passionPassionate: "Leidenschaftlich",
      passionPrimal: "Ungezügelt",
      passionTooltip: "Leidenschaft bestimmt die Bereitschaft des Charakters. Schüchtern (0-15) → Neugierig (16-30) → Flirtend (31-50) → Erhitzt (51-70) → Leidenschaftlich (71-85) → Ungezügelt (86+)",
      presetFresh: "Neu starten",
      presetCurious: "Zu Neugierig springen",
      presetFlirty: "Zu Flirtend springen",
      presetHeated: "Zu Erhitzt springen",
      ...
      passionRising: "Leidenschaft steigt",
      passionFalling: "Leidenschaft sinkt",
      passionStable: "Leidenschaft stabil",
      passionStagnant: "Leidenschaft stagniert — versuche zu eskalieren",
      passionStreak: "Romantische Serie: {count} Nachrichten",
      tierUp: "Leidenschaft: {from} → {to}",
      tierDown: "Abgekühlt: {from} → {to}",
      enableUnchainedConfirm: "Entfesselten Modus aktivieren? Dies deaktiviert die Leidenschafts-Kontrolle — der Charakter reagiert auf intime Inhalte bei jedem Leidenschafts-Level.",
      disableUnchainedConfirm: "Entfesselten Modus deaktivieren? Die Leidenschafts-Kontrolle wird beim aktuellen Level ({level}%) fortgesetzt.",
  ...
  es: {
    ...
    chat: {
      ...
      passionShy: "Tímido",
      passionCurious: "Curioso",
      passionFlirty: "Coqueto",
      passionHeated: "Acalorado",
      passionPassionate: "Apasionado",
      passionPrimal: "Primitivo",
      passionTooltip: "La pasión determina la disposición del personaje. Tímido (0-15) → Curioso (16-30) → Coqueto (31-50) → Acalorado (51-70) → Apasionado (71-85) → Primitivo (86+)",
      presetFresh: "Empezar de nuevo",
      presetCurious: "Saltar a Curioso",
      presetFlirty: "Saltar a Coqueto",
      presetHeated: "Saltar a Acalorado",
      ...
      passionRising: "Pasión subiendo",
      passionFalling: "Pasión bajando",
      passionStable: "Pasión estable",
      passionStagnant: "Pasión estancada — intenta escalar",
  ...
  cn: {
    ...
    chat: {
      ...
      passionPrimal: "原始",
      passionTooltip: "激情决定角色的意愿。害羞 (0-15) → 好奇 (16-30) → 调情 (31-50) → 炽热 (51-70) → 热情 (71-85) → 原始 (86+)",
      presetFresh: "重新开始",
      presetCurious: "跳到好奇",
      presetFlirty: "跳到调情",
      presetHeated: "跳到炽热",
  ...
  fr: {
    ...
    chat: {
      ...
      passionShy: "Timide",
      passionCurious: "Curieux",
      passionFlirty: "Charmeur",
      passionHeated: "Enflammé",
      passionPassionate: "Passionné",
      passionPrimal: "Primitif",
      passionTooltip: "La passion détermine la volonté du personnage. Timide (0-15) → Curieux (16-30) → Charmeur (31-50) → Enflammé (51-70) → Passionné (71-85) → Primitif (86+)",
      presetFresh: "Recommencer",
      presetCurious: "Passer à Curieux",
      presetFlirty: "Passer à Charmeur",
      presetHeated: "Passer à Enflammé",
      ...
      passionRising: "Passion montante",
      passionFalling: "Passion descendante",
      passionStable: "Passion stable",
      passionStagnant: "Passion stagnante — essayez d'intensifier",
      passionStreak: "Série romantique : {count} messages",
      tierUp: "Passion : {from} → {to}",
      tierDown: "Refroidi : {from} → {to}",
      enableUnchainedConfirm: "Activer le Mode Déchaîné ? Cela désactive le contrôle de passion — le personnage répondra au contenu intime à tout niveau de passion.",
      disableUnchainedConfirm: "Désactiver le Mode Déchaîné ? Le contrôle de passion reprendra au niveau actuel ({level}%).",
  ...
  it: {
    ...
    chat: {
      ...
      passionShy: "Timido",
      passionCurious: "Curioso",
      passionFlirty: "Civettuolo",
      passionHeated: "Infuocato",
      passionPassionate: "Appassionato",
      passionPrimal: "Primitivo",
      passionTooltip: "La passione determina la disponibilità del personaggio. Timido (0-15) → Curioso (16-30) → Civettuolo (31-50) → Infuocato (51-70) → Appassionato (71-85) → Primitivo (86+)",
      presetFresh: "Ricominciare",
      presetCurious: "Salta a Curioso",
      presetFlirty: "Salta a Civettuolo",
      presetHeated: "Salta a Infuocato",
      ...
      passionRising: "Passione in aumento",
      passionFalling: "Passione in calo",
      passionStable: "Passione stabile",
      passionStagnant: "Passione stagnante — prova a intensificare",
      passionStreak: "Serie romantica: {count} messaggi",
      tierUp: "Passione: {from} → {to}",
      tierDown: "Raffreddato: {from} → {to}",
      enableUnchainedConfirm: "Attivare la Modalità Scatenata? Questo disabilita il controllo della passione — il personaggio risponderà ai contenuti intimi a qualsiasi livello di passione.",
      disableUnchainedConfirm: "Disattivare la Modalità Scatenata? Il controllo della passione riprenderà al livello attuale ({level}%).",
  ...
  pt: {
    ...
    chat: {
      ...
      passionShy: "Tímido",
      passionCurious: "Curioso",
      passionFlirty: "Paquerador",
      passionHeated: "Acalorado",
      passionPassionate: "Apaixonado",
      passionPrimal: "Primitivo",
      passionTooltip: "A paixão determina a disposição do personagem. Tímido (0-15) → Curioso (16-30) → Paquerador (31-50) → Acalorado (51-70) → Apaixonado (71-85) → Primitivo (86+)",
      presetFresh: "Recomeçar",
      presetCurious: "Pular para Curioso",
      presetFlirty: "Pular para Paquerador",
      presetHeated: "Pular para Acalorado",
      ...
      passionRising: "Paixão subindo",
      passionFalling: "Paixão caindo",
      passionStable: "Paixão estável",
      passionStagnant: "Paixão estagnada — tente escalar",
  ...
  ru: {
    ...
    chat: {
      ...
      passionShy: "Застенчивый",
      passionCurious: "Любопытный",
      passionFlirty: "Кокетливый",
      passionHeated: "Разгорячённый",
      passionPassionate: "Страстный",
      passionPrimal: "Первобытный",
      passionTooltip: "Страсть определяет готовность персонажа. Застенчивый (0-15) → Любопытный (16-30) → Кокетливый (31-50) → Разгорячённый (51-70) → Страстный (71-85) → Первобытный (86+)",
      presetFresh: "Начать заново",
      presetCurious: "Перейти к Любопытному",
      presetFlirty: "Перейти к Кокетливому",
      presetHeated: "Перейти к Разгорячённому",
      ...
      passionRising: "Страсть растёт",
      passionFalling: "Страсть угасает",
      passionStable: "Страсть стабильна",
      passionStagnant: "Страсть стагнирует — попробуйте обострить",
      passionStreak: "Романтическая серия: {count} сообщений",
      tierUp: "Страсть: {from} → {to}",
      tierDown: "Остыло: {from} → {to}",
      enableUnchainedConfirm: "Включить Неограниченный Режим? Это отключает контроль страсти — персонаж будет реагировать на интимный контент при любом уровне страсти.",
      disableUnchainedConfirm: "Отключить Неограниченный Режим? Контроль страсти возобновится на текущем уровне ({level}%).",
  ...
  ja: {
    ...
    chat: {
      ...
      passionFlirty: "小悪魔",
      passionHeated: "情熱的",
      passionPassionate: "激情",
      passionPrimal: "原始的",
      passionTooltip: "情熱がキャラクターの意欲を決定します。恥ずかしがり (0-15) → 好奇心 (16-30) → 小悪魔 (31-50) → 情熱的 (51-70) → 激情 (71-85) → 原始的 (86+)",
      presetFresh: "最初から",
      presetCurious: "好奇心へスキップ",
      presetFlirty: "小悪魔へスキップ",
      presetHeated: "情熱的へスキップ",
      presetPassionate: "激情へスキップ",
      presetMax: "最大",
      ...
      passionRising: "情熱上昇中",
      passionFalling: "情熱低下中",
      passionStable: "情熱安定",
      passionStagnant: "情熱停滞中——エスカレートしてみて",
      passionStreak: "ロマンチック連続：{count}メッセージ",
      tierUp: "情熱：{from} → {to}",
      tierDown: "冷却：{from} → {to}",
      enableUnchainedConfirm: "アンチェインモードを有効にしますか？情熱ゲートキーピングが無効になり、キャラクターはどの情熱レベルでも親密なコンテンツに応答します。",
      disableUnchainedConfirm: "アンチェインモードを無効にしますか？情熱ゲートキーピングが現在のレベル（{level}%）で再開されます。",
      sendMessage: "送信",
      regenerate: "再生成",
      export: "エクスポート",
      import: "インポート",
  ...
  ko: {
    ...
    chat: {
      ...
      passionPrimal: "원초적",
      passionTooltip: "열정이 캐릭터의 의지를 결정합니다. 수줍음 (0-15) → 호기심 (16-30) → 장난스러움 (31-50) → 달아오름 (51-70) → 열정적 (71-85) → 원초적 (86+)",
      presetFresh: "처음부터",
      presetCurious: "호기심으로 건너뛰기",
      presetFlirty: "장난스러움으로 건너뛰기",
      presetHeated: "달아오름으로 건너뛰기",
      ...
      passionRising: "열정 상승 중",
      passionFalling: "열정 하락 중",
      passionStable: "열정 안정",
      passionStagnant: "열정 정체 — 에스컬레이션 시도",
      passionStreak: "로맨틱 연속: {count}개 메시지",
      tierUp: "열정: {from} → {to}",
      tierDown: "식음: {from} → {to}",
      enableUnchainedConfirm: "언체인 모드를 활성화하시겠습니까? 열정 게이트키핑이 비활성화되어 캐릭터가 모든 열정 수준에서 친밀한 콘텐츠에 응답합니다.",
      disableUnchainedConfirm: "언체인 모드를 비활성화하시겠습니까? 열정 게이트키핑이 현재 수준({level}%)에서 재개됩니다.",
      sendMessage: "메시지 전송",
      regenerate: "재생성",
      export: "내보내기",
      import: "가져오기",
  ...
  ar: {
    ...
    chat: {
      ...
      passionShy: "خجول",
      passionCurious: "فضولي",
      passionFlirty: "مغازل",
      passionHeated: "متوهج",
      passionPassionate: "عاطفي",
      passionPrimal: "بدائي",
      passionTooltip: "العاطفة تحدد استعداد الشخصية. خجول (0-15) → فضولي (16-30) → مغازل (31-50) → متوهج (51-70) → عاطفي (71-85) → بدائي (86+)",
      presetFresh: "البدء من جديد",
      presetCurious: "التخطي إلى فضولي",
      presetFlirty: "التخطي إلى مغازل",
      presetHeated: "التخطي إلى متوهج",
      ...
      passionRising: "الشغف يرتفع",
      passionFalling: "الشغف ينخفض",
      passionStable: "الشغف مستقر",
      passionStagnant: "الشغف راكد — حاول التصعيد",
      passionStreak: "سلسلة رومانسية: {count} رسائل",
      tierUp: "الشغف: {from} → {to}",
      tierDown: "تبريد: {from} → {to}",
      enableUnchainedConfirm: "تفعيل الوضع المطلق؟ سيؤدي هذا إلى تعطيل التحكم بالشغف — ستستجيب الشخصية للمحتوى الحميم عند أي مستوى شغف.",
      disableUnchainedConfirm: "تعطيل الوضع المطلق؟ سيستأنف التحكم بالشغف عند المستوى الحالي ({level}%).",
  ...
  hi: {
    ...
    chat: {
      ...
      unchained: "मुक्त मोड",
      passionShy: "शर्मीला",
      passionCurious: "जिज्ञासु",
      passionFlirty: "छेड़छाड़",
      passionHeated: "उत्तेजित",
      passionPassionate: "जुनूनी",
      passionPrimal: "आदिम",
      passionTooltip: "जुनून पात्र की इच्छा निर्धारित करता है। शर्मीला (0-15) → जिज्ञासु (16-30) → छेड़छाड़ (31-50) → उत्तेजित (51-70) → जुनूनी (71-85) → आदिम (86+)",
      presetFresh: "नए सिरे से",
      presetCurious: "जिज्ञासु पर जाएं",
      presetFlirty: "छेड़छाड़ पर जाएं",
      presetHeated: "उत्तेजित पर जाएं",
      ...
      passionRising: "जुनून बढ़ रहा है",
      passionFalling: "जुनून घट रहा है",
      passionStable: "जुनून स्थिर",
      passionStagnant: "जुनून ठहरा — तीव्रता बढ़ाने का प्रयास करें",
      passionStreak: "रोमांटिक श्रृंखला: {count} संदेश",
      tierUp: "जुनून: {from} → {to}",
      tierDown: "ठंडा: {from} → {to}",
      enableUnchainedConfirm: "अनचेन मोड सक्रिय करें? यह जुनून नियंत्रण अक्षम कर देगा — चरित्र किसी भी जुनून स्तर पर अंतरंग सामग्री का जवाब देगा।",
      disableUnchainedConfirm: "अनचेन मोड निष्क्रिय करें? जुनून नियंत्रण वर्तमान स्तर ({level}%) पर फिर से शुरू होगा।",
  ...
  tr: {
    ...
    chat: {
      ...
      passionShy: "Utangaç",
      passionCurious: "Meraklı",
      passionFlirty: "Flörtöz",
      passionHeated: "Kızışmış",
      passionPassionate: "Tutkulu",
      passionPrimal: "İlkel",
      passionTooltip: "Tutku, karakterin istekliliğini belirler. Utangaç (0-15) → Meraklı (16-30) → Flörtöz (31-50) → Kızışmış (51-70) → Tutkulu (71-85) → İlkel (86+)",
      presetFresh: "Yeniden başla",
      presetCurious: "Meraklıya atla",
      presetFlirty: "Flörtöze atla",
      presetHeated: "Kızışmışa atla",
      ...
      passionRising: "Tutku yükseliyor",
      passionFalling: "Tutku düşüyor",
      passionStable: "Tutku stabil",
      passionStagnant: "Tutku durgun — tırmandırmayı deneyin",
      passionStreak: "Romantik seri: {count} mesaj",
      tierUp: "Tutku: {from} → {to}",
      tierDown: "Soğudu: {from} → {to}",
      enableUnchainedConfirm: "Zincirsiz Modu etkinleştir? Bu tutku kontrolünü devre dışı bırakır — karakter herhangi bir tutku seviyesinde samimi içeriğe yanıt verir.",
      disableUnchainedConfirm: "Zincirsiz Modu devre dışı bırak? Tutku kontrolü mevcut seviyede ({level}%) devam edecek.",
