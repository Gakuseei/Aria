const locale = {
  ...
  "settings": {
    ...
    "experimentalDisclaimer": "Recursos em testes — podem produzir resultados inconsistentes. Ajude-nos relatando problemas.",
    "write4meExperimental": "Escrever por Mim (experimental)",
    "write4meExperimentalHelp": "Gera um rascunho de mensagem da sua perspectiva imitando seu estilo de escrita. A qualidade varia. Desativado por padrão.",
    "smartSuggestionsExperimentalHelp": "Gera sugestões rápidas para sua próxima mensagem. Sensível ao ritmo. A qualidade varia em modelos não ingleses. Desativado por padrão.",
  ...
  "chat": {
    ...
    "alternateGreetingPrev": "Saudação anterior",
    "alternateGreetingNext": "Próxima saudação",
    "copy": "Copiar",
  ...
  "characterCreator": {
    ...
    "alternateGreetings": "Saudações Alternativas",
    "alternateGreetingsHelp": "Opcional. Até 5 aberturas alternativas. Os utilizadores podem deslizar entre elas no início do chat.",
    "alternateGreetingPlaceholder": "Uma abertura alternativa para esta personagem — humor, cenário ou ângulo distintos.",
    "addAlternateGreeting": "Adicionar saudação alternativa",
    "removeAlternateGreeting": "Remover",
    "maxAlternateGreetingsReached": "Máximo de 5 saudações alternativas",
    ...
    "aiFailed": "Falha na geração por IA",
    "aiNoModel": "Nenhum modelo Ollama configurado",
    "craftHintLabel": "Dicas de escrita",
    "craftDescription": "A espinha factual: nome, idade, aparência em substantivos concretos e a única tensão que define a vida da personagem. Fatos, não clima — corte tudo o que um estranho adivinharia sem ler a ficha.",
    "craftPersonality": "Dê a ela um desejo e um medo que puxam em direções opostas — o motor que a deixa recusar em vez de só concordar. Mostre as reações padrão como ações (suspiro pesado, um seco «sim, senhor»), não como adjetivos.",
    "craftScenario": "Lugar concreto + relação + a situação de agora, no presente. Nomeie o local; nunca narre o que {{user}} faz.",
    "craftSystemPrompt": "Comece pela única verdade mais decisiva sobre como ela age — pesa mais que qualquer outro campo. Mantenha um parágrafo enxuto de sinal de caráter; não repita regras de formato.",
    "craftInstructions": "Apenas regras táticas — cada linha uma instrução (Mostre… / Mantenha… / Quando…). Nunca comece com «Ela é»; formule no positivo.",
    "craftExampleDialogues": "Mostre a voz como comportamento, nunca declare um traço. Só os dois primeiros chegam ao modelo, então ponha o mais forte primeiro; varie os verbos e o humor entre eles.",
    "craftStartingMessage": "Escreva no comprimento e densidade que você quer em cada resposta. Cena + voz + um gancho limpo; nunca escreva as ações de {{user}} nem termine com «o que você faz?».",
    "craftAlternateGreetings": "Aberturas alternativas para deslizar: mesmas regras da primeira mensagem, mas outra cena. Mantenha a voz, varie o cenário.",
    "craftVoicePin": "A âncora mais forte — reinjetada a cada turno. Uma linha enxuta entre colchetes: cadência, gestos padrão, tom sob pressão. Comprima, não descreva.",
    "craftVoicePinNsfw": "Como ela soa na intimidade — mantenha a frieza, o desafio ou o controle que devem sobreviver à escalada. A excitação se mostra no corpo, não nas palavras.",
    "craftVoiceAvoid": "Liste os clichês de enchimento e de submissão que esta personagem nunca deve dizer. Fraco sozinho — seu real valor é manter seus outros campos limpos.",
    "craftIntimacyContract": "Contrato de ritmo: o consentimento já está dado (nunca pause para perguntar), mas não é obediência imediata. Avance um compasso por vez; nunca termine com um meta-prompt.",
