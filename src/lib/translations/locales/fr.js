const locale = {
  ...
  "settings": {
    ...
    "experimentalDisclaimer": "Fonctionnalités en test — peuvent produire des résultats incohérents. Aidez-nous en signalant les problèmes.",
    "write4meExperimental": "Écrire pour Moi (expérimental)",
    "write4meExperimentalHelp": "Génère un brouillon de message à votre place en imitant votre style d'écriture. La qualité varie. Désactivé par défaut.",
    "smartSuggestionsExperimentalHelp": "Génère des suggestions rapides pour votre prochain message. Sensible au rythme. La qualité varie sur les modèles non anglophones. Désactivé par défaut.",
  ...
  "chat": {
    ...
    "isTyping": "{name} écrit...",
    "alternateGreetingPrev": "Salutation précédente",
    "alternateGreetingNext": "Salutation suivante",
    "copy": "Copier",
  ...
  "characterSelect": {
    ...
    "failedToExport": "Échec de l'exportation",
    "importCharacterFileAria": "Importer un fichier de personnage",
    "storageFull": "Stockage saturé — supprime quelques avatars pour libérer de l'espace",
    "importErrors": {
      "invalidJson": "Ce fichier n'est pas un JSON valide.",
      "notAriaExport": "Ce fichier n'est pas un export Aria.",
  ...
  "characterCreator": {
    ...
    "designCustom": "Créez votre propre IA",
    ...
    "alternateGreetings": "Salutations alternatives",
    "alternateGreetingsHelp": "Optionnel. Jusqu'à 5 ouvertures alternatives. Les utilisateurs peuvent les faire défiler au début du chat.",
    "alternateGreetingPlaceholder": "Une ouverture alternative pour ce personnage — autre humeur, autre cadre, autre angle.",
    "addAlternateGreeting": "Ajouter une salutation alternative",
    "removeAlternateGreeting": "Retirer",
    "maxAlternateGreetingsReached": "Maximum 5 salutations alternatives",
    ...
    "aiFailed": "Échec de la génération par IA",
    "aiNoModel": "Aucun modèle Ollama configuré",
    "craftHintLabel": "Conseils d'écriture",
    "craftDescription": "La colonne vertébrale factuelle : nom, âge, apparence en noms concrets, et la seule tension qui définit sa vie. Des faits, pas des vibes — supprimez ce qu'un inconnu pourrait deviner sans lire la fiche.",
    "craftPersonality": "Donnez-lui un désir et une peur qui s'opposent — le moteur qui lui permet de refuser au lieu de toujours acquiescer. Montrez les réactions par défaut comme des actions (gros soupir, un « oui, monsieur » sec), pas des adjectifs.",
    "craftScenario": "Lieu concret + relation + la situation à l'instant, au présent. Nommez le lieu ; ne racontez jamais ce que fait {{user}}.",
    "craftSystemPrompt": "Commencez par l'unique vérité la plus déterminante sur sa façon d'agir — elle pèse plus que tout autre champ. Un seul paragraphe serré de signal de caractère ; ne répétez pas les règles de format.",
    "craftInstructions": "Uniquement des règles tactiques — chaque ligne une consigne (Montre… / Garde… / Quand…). Ne commencez jamais par « Elle est » ; formulez au positif.",
    "craftExampleDialogues": "Montrez la voix comme un comportement, n'annoncez jamais un trait. Seuls les deux premiers atteignent le modèle : placez le meilleur en premier ; variez les verbes et l'humeur entre eux.",
    "craftStartingMessage": "Écrivez-le à la longueur et la densité que vous voulez pour chaque réponse. Scène + voix + une accroche nette ; n'écrivez jamais les actions de {{user}} et ne finissez pas par « que fais-tu ? ».",
    "craftAlternateGreetings": "Ouvertures alternatives à faire défiler : mêmes règles que le premier message, mais une autre scène. Gardez la voix, variez le décor.",
    "craftVoicePin": "L'ancre la plus forte — réinjectée à chaque tour. Une ligne serrée entre crochets : cadence, gestes par défaut, ton sous pression. Comprimez, ne décrivez pas.",
    "craftVoicePinNsfw": "Comment elle sonne dans l'intimité — gardez la froideur, la défiance ou le contrôle qui doivent survivre à l'escalade. L'excitation se montre dans le corps, pas dans les mots.",
    "craftVoiceAvoid": "Listez les clichés de remplissage et de soumission que ce personnage ne doit jamais dire. Faible seul : sa vraie utilité est de garder vos autres champs propres.",
    "craftIntimacyContract": "Contrat de rythme : le consentement est acquis (ne faites jamais de pause pour demander), mais pas de docilité immédiate. Avancez un temps à la fois ; ne finissez jamais sur une méta-invite.",
  ...
  "creative": {
    ...
    "importStoryFileAria": "Importer un fichier de récit",
    "importErrors": {
      "invalidJson": "Ce fichier n'est pas un JSON valide.",
      "notAriaExport": "Ce fichier n'est pas un export Aria.",
  ...
  "ollamaModal": {
    ...
    "titleNoModel": "Un dernier téléchargement pour finir l'installation",
    ...
    "subDns": "Aria ne trouve pas Ollama à l'adresse indiquée dans les Paramètres. Vérifie que l'adresse est correcte.",
    "subHttp": "Connected to Ollama, but it returned an error (code {status}). Try restarting Ollama.",
    "subNoModel": "Aria doit encore télécharger son modèle IA. Ouvre l'Aria Installer pour finir l'installation.",
    "retry": "Check again",
