const locale = {
  ...
  "chat": {
    ...
    "alternateGreetingPrev": "Önceki selamlama",
    "alternateGreetingNext": "Sonraki selamlama",
    "copy": "Kopyala",
  ...
  "characterCreator": {
    ...
    "designCustom": "Kendi özel AI karakterinizi tasarlayın",
    ...
    "alternateGreetings": "Alternatif Selamlamalar",
    "alternateGreetingsHelp": "İsteğe bağlı. En fazla 5 alternatif açılış. Kullanıcılar sohbet başında bunları kaydırabilir.",
    "alternateGreetingPlaceholder": "Bu karakter için alternatif bir açılış — farklı ruh hâli, mekân veya açı.",
    "addAlternateGreeting": "Alternatif Selamlama Ekle",
    "removeAlternateGreeting": "Kaldır",
    "maxAlternateGreetingsReached": "En fazla 5 alternatif selamlama",
    ...
    "aiFailed": "Yapay zeka üretimi başarısız",
    "aiNoModel": "Yapılandırılmış Ollama modeli yok",
    "craftHintLabel": "Yazım ipuçları",
    "craftDescription": "Olgusal omurga: isim, yaş, somut adlarla görünüm ve hayatını tanımlayan tek gerilim. Hava değil, olgu yaz — bir yabancının kartı okumadan tahmin edebileceği her şeyi çıkar.",
    "craftPersonality": "Ona birbirine karşı çeken bir istek ve bir korku ver — sadece onaylamak yerine reddetmesini sağlayan motor. Varsayılan tepkileri sıfatlarla değil eylemlerle göster (ağır bir iç çekiş, sert bir «evet efendim»).",
    "craftScenario": "Somut yer + ilişki + şu anki durum, şimdiki zamanda. Mekânı adlandır; {{user}}'ın ne yaptığını asla anlatma.",
    "craftSystemPrompt": "Nasıl davrandığına dair en belirleyici tek gerçekle başla — diğer her alandan ağır basar. Karakter sinyalini sıkı tek bir paragrafta tut; biçim kurallarını tekrarlama.",
    "craftInstructions": "Yalnızca taktik kurallar — her satır bir yönerge (Göster… / Koru… / …olduğunda). Asla «O …dır» diye başlama; olumlu kur.",
    "craftExampleDialogues": "Sesi bir davranış olarak göster, asla bir özellik ilan etme. Modele yalnızca ilk ikisi ulaşır, o yüzden en güçlüsünü öne koy; ikisi arasında fiilleri ve ruh halini değiştir.",
    "craftStartingMessage": "Her yanıtta istediğin uzunluk ve yoğunlukta yaz. Sahne + ses + tek temiz kanca; {{user}}'ın eylemlerini asla yazma ve «ne yapıyorsun?» ile bitirme.",
    "craftAlternateGreetings": "Kaydırmalı alternatif açılışlar: ilk mesajla aynı kurallar, ama farklı bir sahne. Sesi koru, mekânı değiştir.",
    "craftVoicePin": "En güçlü çıpa — her turda yeniden enjekte edilir. Köşeli parantez içinde sıkı tek satır: tını, varsayılan hareketler, baskı altında ton. Betimleme, sıkıştır.",
    "craftVoicePinNsfw": "Mahremiyette nasıl duyulduğu — tırmanışta hayatta kalması gereken soğukluğu, meydan okumayı ya da kontrolü koru. Uyarılma sözlerde değil bedende görünür.",
    "craftVoiceAvoid": "Bu karakterin asla söylememesi gereken belirli dolgu ve teslimiyet klişelerini sırala. Tek başına zayıf — asıl değeri diğer alanlarını temiz tutmaktır.",
    "craftIntimacyContract": "Tempo sözleşmesi: rıza zaten var (sormak için asla durma), ama anında itaat değil. Bir vuruş at at ilerle; asla bir meta-istem ile bitirme.",
  },
  "creative": {
