const locale = {
  ...
  "characterCreator": {
    ...
    "aiFailed": "Ошибка ИИ-генерации",
    "aiNoModel": "Модель Ollama не настроена",
    "craftHintLabel": "Советы по написанию",
    "craftDescription": "Фактический стержень: имя, возраст, внешность в конкретных существительных и то единственное напряжение, что определяет её жизнь. Факты, а не настроение — вырежьте всё, что незнакомец угадал бы, не читая карточку.",
    "craftPersonality": "Дайте ей желание и страх, тянущие в разные стороны, — движок, позволяющий отказывать, а не только соглашаться. Реакции по умолчанию показывайте действиями (тяжёлый вздох, сухое «да, сэр»), а не прилагательными.",
    "craftScenario": "Конкретное место + отношения + ситуация прямо сейчас, в настоящем времени. Назовите место; никогда не описывайте, что делает {{user}}.",
    "craftSystemPrompt": "Начните с единственной самой несущей истины о том, как она действует, — она весомее любого другого поля. Держите один плотный абзац сигнала характера; не повторяйте правила формата.",
    "craftInstructions": "Только тактические правила — каждая строка инструкция (Показывай… / Держи… / Когда…). Никогда не начинайте с «Она…»; формулируйте позитивно.",
    "craftExampleDialogues": "Показывайте голос как поведение, никогда не заявляйте черту. До модели доходят лишь первые два, так что ставьте сильнейший первым; меняйте глаголы и настроение между ними.",
    "craftStartingMessage": "Пишите той длины и плотности, какую хотите в каждом ответе. Сцена + голос + один чистый крючок; никогда не пишите действия {{user}} и не заканчивайте на «что ты делаешь?».",
    "craftAlternateGreetings": "Альтернативные вступления для перелистывания: те же правила, что и в первом сообщении, но другая сцена. Держите голос, меняйте обстановку.",
    "craftVoicePin": "Сильнейший якорь — переинъектируется каждый ход. Одна плотная строка в скобках: ритм, привычные жесты, тон под давлением. Сжимайте, а не описывайте.",
    "craftVoicePinNsfw": "Как она звучит в близости — сохраните холод, дерзость или контроль, что должны пережить эскалацию. Возбуждение проявляется в теле, а не в словах.",
    "craftVoiceAvoid": "Перечислите конкретные штампы-филлеры и клише покорности, которые персонаж никогда не должен произносить. Сама по себе слаба — её ценность в том, чтобы держать чистыми другие поля.",
    "craftIntimacyContract": "Контракт темпа: согласие уже есть (никогда не останавливайтесь спросить), но это не мгновенная покорность. Продвигайтесь по одному биту; никогда не заканчивайте мета-подсказкой.",
