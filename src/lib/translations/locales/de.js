const locale = {
  ...
  "settings": {
    ...
    "suggestionModelTitle": "Smart-Suggestions-Modell",
    "suggestionModelDesc": "Ein separates kleines, unzensiertes, non-thinking Modell. Erzeugt die drei Reply-Pills parallel zum Chat-Modell.",
    "suggestionModelInstalled": "INSTALLIERT",
    "suggestionModelNotInstalled": "NICHT INSTALLIERT",
    "suggestionModelPull": "Laden",
    "suggestionModelCheck": "Prüfen",
    "suggestionModelCustom": "Custom (erweitert)",
    "suggestionModelCustomHint": "Beliebigen Ollama-Tag eingeben. Sollte uncensored, non-thinking und JSON-format-fähig sein.",
    "suggestionModelFallbackTitle": "Fallback aufs Chat-Modell",
    "suggestionModelFallbackDesc": "Wenn das Suggestion-Modell fehlt oder fehlschlägt, wird stattdessen das Chat-Modell verwendet.",
    "suggestionModelEditProfile": "Sampling-Profil bearbeiten",
    ...
    "suggestionModelPullStarting": "starte",
    "suggestionModelPullManifest": "Manifest holen",
    "suggestionModelPullDownloading": "lade herunter",
    "suggestionModelPullVerifying": "prüfe",
    "suggestionModelPullWriting": "schreibe",
    "suggestionModelPullCleanup": "räume auf",
    "suggestionModelPullSuccess": "fertig",
    "suggestionModelPullEta": "verbleibt",
    "suggestionModelPullAlmostDone": "fast fertig"
  },
  "chat": {
  ...
  "ollamaModal": {
    "titleUnreachable": "Aria braucht Ollama",
    "titleNoModel": "Letzter Schritt zur Einrichtung",
    "subDefault": "Aria läuft komplett offline mit Ollama. Bitte starte Ollama und klicke auf Erneut prüfen.",
    "subTimeout": "Ollama antwortet nicht. Starte Ollama neu und klicke auf Erneut prüfen.",
    "subRefused": "Aria kann Ollama nicht erreichen. Falls du es gerade installiert hast, öffne es einmal.",
    "subDns": "Aria findet Ollama nicht unter der eingestellten Adresse. Bitte prüfe die Adresse in den Einstellungen.",
    "subHttp": "Verbindung zu Ollama steht, aber es gab einen Fehler (Code {status}). Bitte starte Ollama neu.",
    ...
    "downloadOllama": "Ollama herunterladen (kostenlos)"
  }
};
