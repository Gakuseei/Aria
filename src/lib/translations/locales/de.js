const locale = {
  ...
  "chat": {
    ...
    "alternateGreetingPrev": "Vorherige Begrüßung",
    "alternateGreetingNext": "Nächste Begrüßung",
    "copy": "Kopieren",
  ...
  "characterCreator": {
    ...
    "alternateGreetingsHelp": "Optional. Bis zu 5 alternative Eröffnungen. Nutzer können sie zu Beginn des Chats durchwischen.",
    "alternateGreetingPlaceholder": "Eine alternative Eröffnung für diesen Charakter — andere Stimmung, anderer Schauplatz, anderer Blickwinkel.",
    "addAlternateGreeting": "Alternative Begrüßung hinzufügen",
    "removeAlternateGreeting": "Entfernen",
    "maxAlternateGreetingsReached": "Maximal 5 alternative Begrüßungen",
    ...
    "aiImproving": "Wird verbessert...",
    "aiFailed": "KI-Generierung fehlgeschlagen",
    "aiNoModel": "Kein Ollama-Modell konfiguriert",
    "craftHintLabel": "Schreib-Tipps",
    "craftDescription": "Das faktische Rückgrat: Name, Alter, Aussehen in konkreten Substantiven und die eine Spannung, die ihr Leben bestimmt. Fakten statt Stimmung — streiche alles, was ein Fremder ohne die Karte erraten könnte.",
    "craftPersonality": "Gib ihnen einen Wunsch und eine Angst, die gegeneinander ziehen — der Motor, der sie ablehnen statt nur zustimmen lässt. Zeige Standardreaktionen als Handlungen (schwerer Seufzer, knappes „Ja, Sir\"), nicht als Adjektive.",
    "craftScenario": "Konkreter Ort + Beziehung + die Situation jetzt, im Präsens. Nenne den Ort; erzähle nie, was {{user}} tut.",
    "craftSystemPrompt": "Beginne mit der einen tragendsten Wahrheit darüber, wie sie handeln — sie wiegt schwerer als jedes andere Feld. Halte es bei einem knappen Absatz voller Charaktersignal; wiederhole keine Formatregeln.",
    "craftInstructions": "Nur taktische Regeln — jede Zeile eine Anweisung (Zeige… / Halte… / Wenn…). Beginne nie mit „Sie ist\"; formuliere positiv.",
    "craftExampleDialogues": "Zeige Stimme als Verhalten, nenne nie eine Eigenschaft. Nur die ersten beiden erreichen das Modell, also stelle das stärkste voran; variiere Verben und Stimmung zwischen ihnen.",
    "craftStartingMessage": "Schreibe es in der Länge und Dichte, die jede Antwort haben soll. Szene + Stimme + ein sauberer Haken; schreibe nie {{user}}s Handlungen und ende nicht mit „Was tust du?\".",
    "craftAlternateGreetings": "Alternative Eröffnungen zum Durchwischen: gleiche Regeln wie die erste Nachricht, aber eine andere Szene. Halte die Stimme, variiere den Schauplatz.",
    "craftVoicePin": "Der stärkste Anker — wird jede Runde neu eingespielt. Eine knappe Zeile in Klammern: Kadenz, Standardbewegungen, Ton unter Druck. Verdichten, nicht beschreiben.",
    "craftVoicePinNsfw": "Wie sie in Intimität klingen — bewahre die Kälte, den Trotz oder die Kontrolle, die die Eskalation überstehen müssen. Erregung zeigt sich im Körper, nicht in den Worten.",
    "craftVoiceAvoid": "Liste die konkreten Floskeln und Unterwerfungs-Klischees, die diese Figur nie sagen darf. Allein schwach — der eigentliche Wert liegt darin, deine anderen Felder sauber zu halten.",
    "craftIntimacyContract": "Tempo-Vertrag: Einverständnis steht (nie zum Fragen pausieren), aber keine sofortige Willfährigkeit. Rücke einen Beat nach dem anderen vor; ende nie mit einem Meta-Prompt.",
  },
  "creative": {
