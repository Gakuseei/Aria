const locale = {
  ...
  "settings": {
    ...
    "experimentalDisclaimer": "परीक्षण में सुविधाएँ — असंगत परिणाम दे सकती हैं। समस्याओं की रिपोर्ट करके सुधार में मदद करें।",
    "write4meExperimental": "मेरे लिए लिखें (प्रायोगिक)",
    "write4meExperimentalHelp": "आपकी लेखन शैली की नकल करके आपके दृष्टिकोण से संदेश ड्राफ्ट बनाता है। गुणवत्ता भिन्न होती है। डिफ़ॉल्ट रूप से बंद।",
    "smartSuggestionsExperimentalHelp": "आपके अगले संदेश के लिए त्वरित सुझाव बनाता है। लय-संवेदी। गैर-अंग्रेज़ी मॉडलों में गुणवत्ता भिन्न होती है। डिफ़ॉल्ट रूप से बंद।",
  ...
  "chat": {
    ...
    "alternateGreetingPrev": "पिछला अभिवादन",
    "alternateGreetingNext": "अगला अभिवादन",
    "copy": "कॉपी",
  ...
  "characterCreator": {
    ...
    "designCustom": "अपना खुद का कस्टम AI चरित्र डिज़ाइन करें",
    ...
    "alternateGreetings": "वैकल्पिक अभिवादन",
    "alternateGreetingsHelp": "वैकल्पिक। 5 तक वैकल्पिक शुरुआतें। उपयोगकर्ता चैट के आरंभ में स्वाइप कर सकते हैं।",
    "alternateGreetingPlaceholder": "इस पात्र के लिए वैकल्पिक शुरुआत — अलग मूड, सेटिंग या कोण।",
    "addAlternateGreeting": "वैकल्पिक अभिवादन जोड़ें",
    "removeAlternateGreeting": "हटाएं",
    "maxAlternateGreetingsReached": "अधिकतम 5 वैकल्पिक अभिवादन",
    ...
    "voicePinGenerate": "एआई से सुझाव",
    "voicePinGenerating": "जनरेट हो रहा है...",
    "aiGenerate": "जनरेट करें",
    "aiImprove": "सुधारें",
    "aiGenerating": "जनरेट हो रहा है...",
    "aiImproving": "सुधार हो रहा है...",
    "aiFailed": "एआई जनरेशन विफल",
    "aiNoModel": "कोई Ollama मॉडल कॉन्फ़िगर नहीं है",
    "craftHintLabel": "लेखन सुझाव",
    "craftDescription": "तथ्यात्मक रीढ़: नाम, उम्र, ठोस संज्ञाओं में रूप-रंग, और वह एक तनाव जो उनका जीवन परिभाषित करता है। भाव नहीं, तथ्य लिखें — जो कोई अजनबी बिना कार्ड पढ़े अनुमान लगा सके, उसे हटा दें।",
    "craftPersonality": "उन्हें एक चाह और एक डर दें जो आपस में टकराते हों — वही इंजन जो उन्हें केवल हामी भरने के बजाय इनकार करने देता है। डिफ़ॉल्ट प्रतिक्रियाएँ क्रियाओं के रूप में दिखाएँ (गहरी आह, रूखा «जी, सर»), विशेषणों में नहीं।",
    "craftScenario": "ठोस स्थान + रिश्ता + अभी की स्थिति, वर्तमान काल में। स्थान का नाम लें; {{user}} क्या करता है यह कभी न बताएं।",
    "craftSystemPrompt": "उनके व्यवहार के बारे में सबसे भारी एक सच्चाई से शुरू करें — यह हर दूसरे फ़ील्ड से ज़्यादा वज़नदार है। इसे चरित्र-संकेत का एक कसा हुआ पैराग्राफ़ रखें; फ़ॉर्मेट नियम न दोहराएं।",
    "craftInstructions": "केवल सामरिक नियम — हर पंक्ति एक निर्देश (दिखाएँ… / रखें… / जब…)। कभी «वह है» से शुरू न करें; सकारात्मक रूप में लिखें।",
    "craftExampleDialogues": "स्वर को व्यवहार के रूप में दिखाएँ, कोई गुण घोषित न करें। केवल पहले दो ही मॉडल तक पहुँचते हैं, इसलिए सबसे मज़बूत पहले रखें; उनके बीच क्रियाएँ और मनोदशा बदलें।",
    "craftStartingMessage": "इसे उसी लंबाई और घनत्व में लिखें जैसा आप हर जवाब चाहते हैं। दृश्य + स्वर + एक साफ़ हुक; {{user}} की क्रियाएँ कभी न लिखें और «तुम क्या करते हो?» पर खत्म न करें।",
    "craftAlternateGreetings": "स्वाइप करने योग्य वैकल्पिक शुरुआतें: पहले संदेश जैसे ही नियम, पर अलग दृश्य। स्वर बनाए रखें, परिवेश बदलें।",
    "craftVoicePin": "सबसे मज़बूत लंगर — हर बारी फिर से डाला जाता है। कोष्ठक में एक कसी पंक्ति: लय, डिफ़ॉल्ट हरकतें, दबाव में स्वर। संकुचित करें, वर्णन न करें।",
    "craftVoicePinNsfw": "अंतरंगता में वे कैसे लगते हैं — वह ठंडक, अवज्ञा या नियंत्रण बनाए रखें जो चरम तक टिकना चाहिए। उत्तेजना शरीर में दिखती है, शब्दों में नहीं।",
    "craftVoiceAvoid": "उन विशिष्ट घिसे-पिटे और समर्पण के जुमलों की सूची बनाएं जो यह पात्र कभी न कहे। अकेले कमज़ोर — इसका असली मूल्य आपके बाकी फ़ील्ड साफ़ रखना है।",
    "craftIntimacyContract": "गति अनुबंध: सहमति पहले से है (पूछने के लिए कभी न रुकें), पर तुरंत आज्ञापालन नहीं। एक बार में एक बीट आगे बढ़ें; कभी मेटा-प्रॉम्प्ट पर खत्म न करें।",
  ...
  "loadGame": {
    ...
    "searchHint": "अलग कीवर्ड आज़माएँ।",
    "matchCount": "{count} परिणाम",
    "matchCountOne": "1 परिणाम",
  ...
  "characters": {
    ...
    "narrator-chronicler": {
      "name": "The Chronicler",
      "subtitle": "साहित्यिक कथाकार",
      "tagline": "साहित्यिक, सर्वज्ञ।",
      "description": "एक तटस्थ साहित्यिक तृतीय-पुरुष सर्वज्ञ कथाकार। संयमित, अवलोकनशील गद्य जो आपकी इनपुट को बातचीत के बजाय एक दृश्य में बदल देता है।"
    },
    "narrator-noir": {
      "name": "Noir Narrator",
      "subtitle": "नॉयर कथाकार",
      "tagline": "नॉयर, वर्तमान काल।",
      "description": "एक कठोर नॉयर कथाकार। वर्तमान काल। मुक्के की तरह उतरने वाले छोटे वाक्य। धुआँ, बारिश, सस्ती व्हिस्की और परिणाम।"
    }
  },
  "ollamaModal": {
    "titleUnreachable": "Open Ollama",
    "titleNoModel": "सेटअप पूरा करने के लिए एक आख़िरी डाउनलोड",
    ...
    "subDns": "Aria को सेटिंग्स में दिए गए पते पर Ollama नहीं मिल रहा। जाँच लो कि पता सही है।",
    "subHttp": "Connected to Ollama, but it returned an error (code {status}). Try restarting Ollama.",
    "subNoModel": "Aria को अब भी अपना AI मॉडल डाउनलोड करना है। सेटअप पूरा करने के लिए Aria Installer खोलो।",
    "retry": "Check again",
    "settings": "एडवांस्ड सेटिंग्स"
  }
};
