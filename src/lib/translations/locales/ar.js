const locale = {
  ...
  "settings": {
    ...
    "experimentalDisclaimer": "ميزات قيد الاختبار — قد تنتج نتائج غير متسقة. ساعدنا بالإبلاغ عن المشكلات.",
    "write4meExperimental": "اكتب نيابةً عني (تجريبي)",
    "write4meExperimentalHelp": "ينشئ مسودة رسالة من منظورك بمحاكاة أسلوب كتابتك. الجودة متفاوتة. متوقف افتراضياً.",
    "smartSuggestionsExperimentalHelp": "ينشئ اقتراحات سريعة لرسالتك التالية. متوافق مع الإيقاع. الجودة تتفاوت في النماذج غير الإنجليزية. متوقف افتراضياً.",
  ...
  "chat": {
    ...
    "isTyping": "{name} يكتب...",
    "alternateGreetingPrev": "التحية السابقة",
    "alternateGreetingNext": "التحية التالية",
    "copy": "نسخ",
  ...
  "characterCreator": {
    ...
    "designCustom": "صمم AI المخصص الخاص بك",
    ...
    "alternateGreetings": "تحيات بديلة",
    "alternateGreetingsHelp": "اختياري. حتى 5 افتتاحيات بديلة. يمكن للمستخدمين التمرير بينها في بداية المحادثة.",
    "alternateGreetingPlaceholder": "افتتاحية بديلة لهذه الشخصية — مزاج، إعداد، أو زاوية مختلفة.",
    "addAlternateGreeting": "إضافة تحية بديلة",
    "removeAlternateGreeting": "إزالة",
    "maxAlternateGreetingsReached": "الحد الأقصى 5 تحيات بديلة",
    ...
    "aiImproving": "جارٍ التحسين...",
    "aiFailed": "فشل التوليد بالذكاء الاصطناعي",
    "aiNoModel": "لا يوجد نموذج Ollama مُهيّأ",
    "craftHintLabel": "نصائح الكتابة",
    "craftDescription": "العمود الفقري للحقائق: الاسم والعمر والمظهر بأسماء ملموسة، والتوتر الوحيد الذي يحدد حياتها. اكتب حقائق لا أجواء — احذف كل ما قد يخمّنه غريب دون قراءة البطاقة.",
    "craftPersonality": "امنحها رغبة وخوفًا يتجاذبان — المحرّك الذي يتيح لها الرفض بدل مجرد الموافقة. أظهر ردودها الافتراضية كأفعال (تنهيدة ثقيلة، «نعم يا سيدي» جافة) لا كصفات.",
    "craftScenario": "مكان ملموس + علاقة + الموقف الآن، بصيغة المضارع. سمِّ المكان؛ ولا تروِ أبدًا ما يفعله {{user}}.",
    "craftSystemPrompt": "ابدأ بالحقيقة الأكثر محورية عن كيفية تصرفها — فهي أثقل من أي حقل آخر. اجعلها فقرة واحدة مركّزة من إشارات الطبع؛ ولا تكرر قواعد التنسيق.",
    "craftInstructions": "قواعد تكتيكية فقط — كل سطر تعليمة (أظهر… / حافظ… / عندما…). لا تبدأ أبدًا بـ«هي…»؛ وصُغ بالإيجاب.",
    "craftExampleDialogues": "أظهر الصوت كسلوك، ولا تعلن سمة أبدًا. لا يصل النموذج سوى الأولين، فضع الأقوى أولًا؛ ونوّع الأفعال والمزاج بينهما.",
    "craftStartingMessage": "اكتبها بالطول والكثافة اللذين تريدهما في كل رد. مشهد + صوت + خطّاف نظيف واحد؛ ولا تكتب أفعال {{user}} أبدًا ولا تُنهِ بـ«ماذا تفعل؟».",
    "craftAlternateGreetings": "افتتاحيات بديلة للتمرير: القواعد نفسها كالرسالة الأولى، لكن بمشهد مختلف. حافظ على الصوت، ونوّع المكان.",
    "craftVoicePin": "أقوى مرساة — تُحقن من جديد كل دور. سطر واحد مركّز بين قوسين معقوفين: الإيقاع، الحركات الافتراضية، النبرة تحت الضغط. اضغط ولا تصف.",
    "craftVoicePinNsfw": "كيف تبدو في الحميمية — احتفظ بالبرود أو التحدي أو السيطرة التي يجب أن تصمد أثناء التصعيد. الإثارة تظهر في الجسد لا في الكلمات.",
    "craftVoiceAvoid": "اذكر عبارات الحشو وكليشيهات الاستسلام المحددة التي يجب ألا تقولها هذه الشخصية أبدًا. ضعيفة بمفردها — قيمتها الحقيقية إبقاء حقولك الأخرى نظيفة.",
    "craftIntimacyContract": "عقد الإيقاع: الموافقة قائمة (لا تتوقف أبدًا للسؤال)، لكنها ليست طاعة فورية. تقدّم نبضة واحدة في كل مرة؛ ولا تُنهِ أبدًا بموجّه واصف.",
