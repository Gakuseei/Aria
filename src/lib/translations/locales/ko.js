const locale = {
  ...
  "settings": {
    ...
    "userGender": "성별",
    "userPronouns": "대명사",
    "pronounsHelper": "성별에 따라 자동 설정. 편집으로 덮어쓰기 가능.",
    "pronounsCustom": "사용자 지정...",
    "pronounsCustomPlaceholder": "예: ze/zir, fae/faer, 임의의 대명사",
    "oledMode": "OLED 모드",
    "themeMode": "테마",
    "darkMode": "다크",
    "lightMode": "라이트",
    ...
    "voiceStandard": "표준",
    "voicePremium": "프리미엄",
    "samplingModalEyebrow": "모델별",
    "samplingModalTitle": "Sampling 설정",
    "samplingModalOverridesActive": "{count}개 재정의 활성화",
    "samplingModalOverridesActivePlural": "{count}개 재정의 활성화",
    "samplingModalNoOverrides": "재정의 없음",
    "samplingPanelEdit": "편집",
    "samplingPanelSummary": "{summary}",
    "samplingTabSampling": "Sampling",
    "samplingTabDry": "DRY",
    "samplingDrySectionCap": "매개변수",
    "samplingFooterControls": "{count}개 컨트롤 — {tab}",
    "samplingFooterControlsOne": "{count}개 컨트롤 — {tab}",
    "samplingFooterReset": "모두 초기화",
    "samplingFooterDone": "완료",
    "samplingHelperTemperature": "낮음 = 집중되고 예측 가능. 높음 = 창의적이고 의외성 있음.",
    "samplingHelperTopP": "Nucleus sampling — 누적 확률 기준 상위 토큰.",
    "samplingHelperMinP": "낮은 확률의 토큰을 제거해 일관성을 높입니다.",
    "samplingHelperRepeatPenalty": "최근 토큰의 반복을 억제합니다. 1.0 = 끔.",
    "samplingHelperTopK": "토큰별 후보 수의 절대 상한. 0 = 비활성.",
    "samplingHelperRepeatLastN": "Repeat Penalty를 적용할 거슬러 올라가는 범위.",
    "samplingHelperPenalizeNewline": "줄바꿈을 반복으로 간주합니다.",
    "samplingHelperDry": "Repeat Penalty보다 강하게 글자 그대로의 반복을 처벌합니다.",
    ...
    "suggestionModelCheck": "확인",
    "suggestionModelCustom": "사용자 지정 (고급)",
    "suggestionModelCustomHint": "Ollama 태그를 입력하세요. 무검열, 비사고형이며 JSON 형식을 지원해야 합니다.",
    "suggestionModelFallbackTitle": "채팅 모델로 폴백",
    "suggestionModelFallbackDesc": "제안 모델이 실패하거나 사용할 수 없는 경우 채팅 모델을 대신 사용합니다.",
    "suggestionModelEditProfile": "샘플링 프로필 편집",
  ...
  "chat": {
    ...
    "suggestButton": "답장 제안",
    "suggestLoading": "생성 중…",
    "suggestError": "제안을 사용할 수 없습니다.",
    "impersonate": "대신 써줘",
    "editMessage": "메시지 편집",
    "editSave": "저장",
    "editCancel": "취소",
    "revertTurn": "마지막 턴 되돌리기",
    "isTyping": "{name} 입력 중...",
    "playAudio": "재생",
    "copy": "복사",
