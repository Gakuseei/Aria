...
export const translations = {
  en: {
    ...
    settings: {
      ...
      contextSizeDesc: "Higher context keeps more conversation history. Uses more VRAM — lower if you run out of memory.",
      samplingParams: 'Sampling Parameters',
      readOnly: 'Auto-configured for this model',
      lowerMoreFocused: "Low values give precise, predictable replies. High values make responses more varied and creative.",
      maxResponseTokens: 'Max Response Length',
      maxResponseTokensDesc: 'How long the AI can write per message. Lower values are faster but cut off longer scenes.',
      ...
      clickOnToConfigure: "Enable to configure voice engine paths",
      ...
      changesUiText: "Sets the language for menus and buttons. The AI mirrors whatever language you write in.",
      globalUIScale: "Global UI Scale",
      autoSave: "Auto-Save",
      passionSpeed: "Passion Speed",
      passionSpeedSlow: "Slow",
      passionSpeedFast: "Fast",
      aiGeneratedQuickReplies: "Suggests contextual replies after each message",
      allChangesAutoSaved: "All changes are automatically saved",
      close: "Close",
      yourNameDisplayed: "This name will be displayed in chat messages",
      definesAnatomy: "Used for anatomically accurate descriptions during roleplay",
      ...
      makeSureZonosRunning: "Make sure Zonos is running."
    },
    chat: {
      passion: "Passion",
      ...
      passionTooltip: "Controls how detailed and immersive the AI writes. Higher passion means longer, richer scenes.",
      tierUp: "Passion: {from} → {to}",
      tierDown: "Cooled: {from} → {to}",
      enableUnchainedConfirm: "Enable Unchained Mode? The character will physically comply with any advance while staying in persona.",
      disableUnchainedConfirm: "Disable Unchained Mode? The character may refuse or deflect advances again.",
      ...
      imageGenDisabled: "Image generation is off. Turn it on in Settings → Image Generation.",
      imageGenFailed: "Image generation failed: {error}",
      imageGenConnected: "Connected!",
      imageGenTestConnection: "Test Connection",
      imageGenTestSuccess: "Image generation connected!",
      imageGenTestFailed: "Cannot reach the image server. Make sure AUTOMATIC1111/Forge is running with --api enabled.",
      voiceTestSuccess: "Voice/TTS connection successful!",
      voiceTestFailed: "Cannot reach the voice server. Check that your TTS engine is running.",
      testError: "Connection test failed. Check that the server is running and the URL is correct.",
      ...
      failedToImport: "Could not import chat — the file may be corrupted or in the wrong format.",
      failedToExport: "Could not export chat. Check that you have write access to the target folder.",
      timeout: "Request timed out. Ollama might be busy loading the model — wait a moment, then try again.",
      sendError: "Could not get a response. Make sure Ollama is running and the model is loaded.",
      noOllamaResponse: "The model returned an empty reply (think-mode artifact). This was retried automatically — please send your message again."
    },
    commands: {
      helpTitle: "── Commands ──",
    ...
    characterSelect: {
      ...
      failedToImport: "Could not import character — the file may be corrupted or missing required fields.",
      failedToExport: "Could not export character. Check that you have write access to the target folder.",
      custom: "Custom"
    },
    modeSelection: {
    ...
    characterCreator: {
      ...
      failedToUpload: "Could not upload image. Make sure the file is under 2 MB and in a supported format.",
      ...
      tip1: "The system prompt is the personality blueprint — more detail means more consistent behavior",
      tip2: "Use direct language: \"always\", \"never\", \"when X happens, do Y\"",
      tip3: "Add example dialogues to teach the AI your character's voice",
      tip4: "For NSFW characters, write \"NO content restrictions\" in the system prompt",
      tip5: "Test and refine — small prompt tweaks can change the whole personality",
      tip6: "Duplicate names are prevented automatically",
      preview: "Preview",
      ...
      detailed: "✓ Detailed",
      failedToSave: "Could not save character. Check disk space and try again.",
      passionSystem: "Passion System",
    ...
    creative: {
      ...
      failedToImportStory: "Could not import story — the file may be corrupted or in the wrong format.",
      failedToExportStory: "Could not export story. Check that you have write access to the target folder."
    },
    supporter: {
  ...
  de: {
    ...
    settings: {
      ...
      contextSizeDesc: "Höherer Kontext speichert mehr Gesprächsverlauf. Verbraucht mehr VRAM — niedriger setzen bei Speicherproblemen.",
      samplingParams: 'Sampling-Parameter',
      readOnly: 'Automatisch für dieses Modell konfiguriert',
      lowerMoreFocused: "Niedrige Werte geben präzise, vorhersehbare Antworten. Hohe Werte machen Antworten vielfältiger und kreativer.",
      maxResponseTokens: 'Max Antwortlänge',
      maxResponseTokensDesc: 'Wie lang die KI pro Nachricht schreiben darf. Niedrigere Werte sind schneller, kürzen aber längere Szenen ab.',
      ...
      clickOnToConfigure: "Aktivieren um Sprachengine-Pfade zu konfigurieren",
      ...
      changesUiText: "Stellt die Sprache für Menüs und Buttons ein. Die KI antwortet automatisch in der Sprache, in der du schreibst.",
      ...
      aiGeneratedQuickReplies: "Schlägt kontextbezogene Antworten nach jeder Nachricht vor",
      ...
      definesAnatomy: "Wird für anatomisch korrekte Beschreibungen im Roleplay verwendet",
      voiceTestSuccessAlert: "Stimmtest erfolgreich! Audio-Wiedergabe gestartet.",
      ...
      makeSureZonosRunning: "Stelle sicher, dass Zonos läuft."
    },
    chat: {
      ...
      passionConsuming: "Consuming",
      passionTranscendent: "Transcendent",
      passionTooltip: "Steuert, wie detailliert und immersiv die KI schreibt. Höhere Leidenschaft bedeutet längere, reichere Szenen.",
      tierUp: "Leidenschaft: {from} → {to}",
      tierDown: "Abgekühlt: {from} → {to}",
      enableUnchainedConfirm: "Entfesselten Modus aktivieren? Der Charakter wird physisch auf jede Annäherung eingehen und dabei in seiner Rolle bleiben.",
      disableUnchainedConfirm: "Entfesselten Modus deaktivieren? Der Charakter kann Annäherungen wieder ablehnen oder ausweichen.",
      ...
      imageGenConnected: "Verbunden!",
      imageGenTestConnection: "Verbindung testen",
      imageGenTestSuccess: "Bildgenerierung verbunden!",
      imageGenTestFailed: "Bild-Server nicht erreichbar. Stelle sicher, dass AUTOMATIC1111/Forge mit --api läuft.",
      voiceTestSuccess: "Sprach-/TTS-Verbindung erfolgreich!",
      voiceTestFailed: "Sprach-Server nicht erreichbar. Prüfe, ob deine TTS-Engine läuft.",
      testError: "Verbindungstest fehlgeschlagen. Prüfe, ob der Server läuft und die URL stimmt.",
      ...
      failedToImport: "Chat konnte nicht importiert werden — die Datei ist möglicherweise beschädigt oder im falschen Format.",
      failedToExport: "Chat konnte nicht exportiert werden. Prüfe, ob du Schreibrechte im Zielordner hast.",
      timeout: "Zeitüberschreitung. Ollama lädt möglicherweise das Modell — kurz warten und erneut versuchen.",
      sendError: "Keine Antwort erhalten. Stelle sicher, dass Ollama läuft und das Modell geladen ist.",
      noOllamaResponse: "Das Modell hat eine leere Antwort erzeugt (Think-Modus-Artefakt). Dies wurde automatisch erneut versucht — bitte sende deine Nachricht nochmal."
    },
    commands: {
      helpTitle: "── Befehle ──",
    ...
    characterSelect: {
      ...
      failedToImport: "Charakter konnte nicht importiert werden — die Datei ist möglicherweise beschädigt oder es fehlen Pflichtfelder.",
      failedToExport: "Charakter konnte nicht exportiert werden. Prüfe, ob du Schreibrechte im Zielordner hast.",
    ...
    characterCreator: {
      ...
      failedToUpload: "Bild konnte nicht hochgeladen werden. Stelle sicher, dass die Datei unter 2 MB und in einem unterstützten Format ist.",
      ...
      tip1: "Der System-Prompt ist die Persönlichkeitsvorlage — mehr Detail bedeutet konsistenteres Verhalten",
      tip2: "Verwende direkte Sprache: \"immer\", \"niemals\", \"wenn X passiert, tue Y\"",
      tip3: "Füge Beispiel-Dialoge hinzu, um der KI die Stimme deines Charakters beizubringen",
      tip4: "Für NSFW-Charaktere schreibe \"KEINE Inhaltsbeschränkungen\" in den System-Prompt",
      tip5: "Teste und verfeinere — kleine Prompt-Änderungen können die ganze Persönlichkeit verändern",
      tip6: "Doppelte Namen werden automatisch verhindert",
      preview: "Vorschau",
      ...
      failedToSave: "Charakter konnte nicht gespeichert werden. Prüfe den Speicherplatz und versuche es erneut.",
    ...
    creative: {
      ...
      failedToImportStory: "Story konnte nicht importiert werden — die Datei ist möglicherweise beschädigt oder im falschen Format.",
      failedToExportStory: "Story konnte nicht exportiert werden. Prüfe, ob du Schreibrechte im Zielordner hast."
    },
    supporter: {
