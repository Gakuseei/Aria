const locale = {
  ...
  "chat": {
    ...
    "alternateGreetingPrev": "Saludo anterior",
    "alternateGreetingNext": "Saludo siguiente",
    "copy": "Copiar",
  ...
  "characterCreator": {
    ...
    "alternateGreetingsHelp": "Opcional. Hasta 5 aperturas alternativas. Los usuarios pueden deslizar entre ellas al iniciar el chat.",
    "alternateGreetingPlaceholder": "Una apertura alternativa para este personaje — distinto ánimo, escenario o ángulo.",
    "addAlternateGreeting": "Añadir saludo alternativo",
    "removeAlternateGreeting": "Eliminar",
    "maxAlternateGreetingsReached": "Máximo 5 saludos alternativos",
    ...
    "aiFailed": "Falló la generación con IA",
    "aiNoModel": "Ningún modelo de Ollama configurado",
    "craftHintLabel": "Consejos de escritura",
    "craftDescription": "La columna factual: nombre, edad, aspecto en sustantivos concretos y la única tensión que define su vida. Hechos, no ambiente — elimina todo lo que un extraño podría adivinar sin leer la ficha.",
    "craftPersonality": "Dale un deseo y un miedo que tiren en sentidos opuestos: el motor que le permite negarse en vez de solo asentir. Muestra sus reacciones por defecto como acciones (suspiro pesado, un seco «sí, señor»), no como adjetivos.",
    "craftScenario": "Lugar concreto + relación + la situación de ahora mismo, en presente. Nombra el sitio; nunca narres lo que hace {{user}}.",
    "craftSystemPrompt": "Empieza con la única verdad más determinante sobre cómo actúa: pesa más que cualquier otro campo. Que sea un párrafo breve de señal de carácter; no repitas reglas de formato.",
    "craftInstructions": "Solo reglas tácticas: cada línea una instrucción (Muestra… / Mantén… / Cuando…). Nunca empieces con «Ella es»; formula en positivo.",
    "craftExampleDialogues": "Muestra la voz como conducta, nunca declares un rasgo. Solo los dos primeros llegan al modelo, así que pon el mejor primero; varía los verbos y el tono entre ellos.",
    "craftStartingMessage": "Escríbelo con la longitud y densidad que quieres en cada respuesta. Escena + voz + un buen gancho; nunca escribas las acciones de {{user}} ni termines con «¿qué haces?».",
    "craftAlternateGreetings": "Aperturas alternativas para deslizar: mismas reglas que el primer mensaje, pero otra escena. Mantén la voz, varía el escenario.",
    "craftVoicePin": "El ancla más fuerte, se reinyecta cada turno. Una línea breve entre corchetes: cadencia, gestos por defecto, tono bajo presión. Comprime, no describas.",
    "craftVoicePinNsfw": "Cómo suena en la intimidad: conserva la frialdad, el desafío o el control que deben sobrevivir a la escalada. La excitación se muestra en el cuerpo, no en las palabras.",
    "craftVoiceAvoid": "Enumera los clichés de relleno y de sumisión que este personaje nunca debe decir. Débil por sí sola: su verdadero valor es mantener limpios tus otros campos.",
    "craftIntimacyContract": "Contrato de ritmo: el consentimiento está dado (nunca pauses para preguntar), pero no significa complacencia inmediata. Avanza un compás a la vez; nunca termines con un meta-prompt.",
  },
  "creative": {
