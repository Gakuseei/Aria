const locale = {
  ...
  "settings": {
    ...
    "userPronouns": "Pronomi",
    "pronounsHelper": "Impostato automaticamente dal genere. Modifica per sovrascrivere.",
    "pronounsCustom": "Personalizzati...",
    "pronounsCustomPlaceholder": "es. ze/zir, fae/faer, qualsiasi pronome",
    ...
    "samplingModalEyebrow": "Per modello",
    "samplingModalTitle": "Impostazioni Sampling",
    "samplingModalOverridesActive": "{count} override attivo",
    "samplingModalOverridesActivePlural": "{count} override attivi",
    "samplingModalNoOverrides": "Nessun override",
    "samplingPanelEdit": "Modifica",
    "samplingPanelSummary": "{summary}",
    "samplingTabSampling": "Sampling",
    "samplingTabDry": "DRY",
    "samplingDrySectionCap": "Parametri",
    "samplingFooterControls": "{count} controlli — {tab}",
    "samplingFooterControlsOne": "{count} controllo — {tab}",
    "samplingFooterReset": "Reimposta tutto",
    "samplingFooterDone": "Fatto",
    "samplingHelperTemperature": "Basso = preciso e prevedibile. Alto = creativo e sorprendente.",
    "samplingHelperTopP": "Nucleus sampling — token principali per probabilità cumulativa.",
    "samplingHelperMinP": "Scarta token a bassa probabilità per maggiore coerenza.",
    "samplingHelperRepeatPenalty": "Scoraggia la ripetizione dei token recenti. 1.0 = disattivato.",
    "samplingHelperTopK": "Limite rigido sui candidati per token. 0 = disattivato.",
    "samplingHelperRepeatLastN": "Quanto indietro si applica la Repeat Penalty.",
    "samplingHelperPenalizeNewline": "Tratta gli a capo come ripetizione.",
    "samplingHelperDry": "Penalizza le ripetizioni letterali più di Repeat Penalty.",
    "samplingHelperDryMultiplier": "Intensità della penalità di ripetizione.",
    "samplingHelperDryBase": "Più alto = penalità più forte per ripetizioni più lunghe.",
    "samplingHelperDryAllowedLength": "Ripetizioni fino a questa lunghezza passano senza penalità.",
    ...
    "suggestionModelCheck": "Verifica",
    "suggestionModelCustom": "Personalizzato (avanzato)",
    "suggestionModelCustomHint": "Inserisci un tag Ollama qualsiasi. Deve essere senza censura, senza ragionamento e compatibile con il formato JSON.",
    "suggestionModelFallbackTitle": "Ripiega sul modello di chat",
    "suggestionModelFallbackDesc": "Se il modello di suggerimenti fallisce o non è disponibile, viene usato il modello di chat.",
    "suggestionModelEditProfile": "Modifica profilo di campionamento",
  ...
  "chat": {
    ...
    "send": "Invia",
    "suggestButton": "Suggerisci risposte",
    "suggestLoading": "Generazione…",
    "suggestError": "Suggerimenti non disponibili.",
    "impersonate": "Scrivi per me",
    "editMessage": "Modifica messaggio",
    "editSave": "Salva",
    "editCancel": "Annulla",
    "revertTurn": "Annulla ultimo turno",
