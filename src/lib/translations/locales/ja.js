const locale = {
  ...
  "settings": {
    ...
    "userGender": "性別",
    "userPronouns": "代名詞",
    "pronounsHelper": "性別から自動設定。編集で上書き可能。",
    "pronounsCustom": "カスタム...",
    "pronounsCustomPlaceholder": "例: ze/zir, fae/faer など任意",
    "oledMode": "OLEDモード",
    "themeMode": "テーマ",
    "darkMode": "ダーク",
    "lightMode": "ライト",
    ...
    "voicePremium": "プレミアム",
    "samplingModalEyebrow": "モデル別",
    "samplingModalTitle": "Sampling 設定",
    "samplingModalOverridesActive": "{count} 件のオーバーライドが有効",
    "samplingModalOverridesActivePlural": "{count} 件のオーバーライドが有効",
    "samplingModalNoOverrides": "オーバーライドなし",
    "samplingPanelEdit": "編集",
    "samplingPanelSummary": "{summary}",
    "samplingTabSampling": "Sampling",
    "samplingTabDry": "DRY",
    "samplingDrySectionCap": "パラメータ",
    "samplingFooterControls": "{count} 個のコントロール — {tab}",
    "samplingFooterControlsOne": "{count} 個のコントロール — {tab}",
    "samplingFooterReset": "すべてリセット",
    "samplingFooterDone": "完了",
    "samplingHelperTemperature": "低い = 集中して予測可能。高い = 創造的で意外性あり。",
    "samplingHelperTopP": "Nucleus sampling — 累積確率による上位トークン。",
    "samplingHelperMinP": "低確率のトークンを除外し、一貫性を高めます。",
    "samplingHelperRepeatPenalty": "直近のトークンの繰り返しを抑制します。1.0 = 無効。",
    "samplingHelperTopK": "トークンごとの候補数の上限。0 = 無効。",
    "samplingHelperRepeatLastN": "Repeat Penalty を遡って適用する範囲。",
    "samplingHelperPenalizeNewline": "改行を繰り返しとして扱います。",
    "samplingHelperDry": "Repeat Penalty より強く、字句どおりの繰り返しを罰します。",
    ...
    "suggestionModelCheck": "確認",
    "suggestionModelCustom": "カスタム（上級）",
    "suggestionModelCustomHint": "任意の Ollama タグを入力。無検閲・非思考型で JSON 形式に対応している必要があります。",
    "suggestionModelFallbackTitle": "チャットモデルにフォールバック",
    "suggestionModelFallbackDesc": "提案モデルが失敗、または利用できない場合は、代わりにチャットモデルを使用します。",
    "suggestionModelEditProfile": "サンプリングプロファイルを編集",
  ...
  "chat": {
    ...
    "suggestButton": "返信を提案",
    "suggestLoading": "生成中…",
    "suggestError": "候補は利用できません。",
    "impersonate": "代わりに書く",
    "editMessage": "メッセージを編集",
    "editSave": "保存",
    "editCancel": "キャンセル",
    "revertTurn": "最後のターンを元に戻す",
    "isTyping": "{name} 入力中...",
    "playAudio": "再生",
    "copy": "コピー",
    "generateImage": "画像生成",
